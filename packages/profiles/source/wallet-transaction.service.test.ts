		...
		const input = {
			...
			signatory: new Signatories.Signatory(
				new Signatories.MnemonicSignatory({
					...
					publicKey: "publicKey",
					signingKey: "fly quote board process robust adjust ostrich silly remove tourist about dash code favorite exact short kitten evil sentence quiz mango valve noodle include",
				}),
			),
		};
