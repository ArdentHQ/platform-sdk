...
describe("BIP44 wallet", ({ afterEach, beforeEach, it, nock, assert }) => {
	beforeEach(async (context) => {
		...
		nock.fake("https://btc-test.ardenthq.com:443", { encodedQueryParams: true })
			.post(
			...
			.reply(
				200,
				'{"data":[{"address":"mqLZY69ZjogwvFWfLEuGdFUPKeZ6JvyRj1","txId":"94336a791ade1aee7a55f0132e1c766e7272b304b805347f34a716cd0b10ebe6","outputIndex":0,"script":"76a9146bba19cd7beb53addb39ab750531668ad409474688ac","satoshis":1000000},{"address":"mv9pNZs3d65sjL68JueZDphWe3vHNmmSn6","txId":"3b182fedfbf8dca089b5ff97004e53081c6610a2eb08dd9bd8c3243a64216649","outputIndex":0,"script":"76a914a08a89d81d7a9be55a18d12f9808dcd572e2cd1c88ac","satoshis":1000000},{"address":"mwhFCM54gRxY27ynaB7xmmuuGpxATWDzXd","txId":"473f473a78f569e93ebd0955d3eb5855c888938106e8f55670c6b75ec1b44d16","outputIndex":0,"script":"76a914b17447e9524445be6572706a3ccfdc9c0e2a8ae788ac","satoshis":1000000}],"links":{"first":"https:\\/\\/btc-test.ardenthq.comcom\\/api\\/wallets\\/transactions\\/unspent?page=1","last":"https:\\/\\/btc-teardenthq.comhq.com\\/api\\/wallets\\/transactions\\/unspent?page=1","prev":null,"next":null},"meta":{"current_page":1,"from":1,"last_page":1,"links":[{"url":null,"label":"&laquo; Previous","active":false},{"url":"https:\\/\\/btcardenthq.comenthq.com\\/api\\/wallets\\/transactions\\/unspent?page=1","label":"1","active":true},{"url":null,"label":"Next &raquo;","active":false}],"path":"https:\\/\\/ardenthq.comardenthq.com\\/api\\/wallets\\/transactions\\/unspent","per_page":15,"to":3,"total":3}}',
			)
			.post(
...
describe("BIP49 wallet", ({ afterEach, beforeEach, it, nock, assert }) => {
	beforeEach(async (context) => {
		...
		nock.fake("https://btc-test.ardenthq.comcom:443", { encodedQueryParams: true })
			.post(
				"/api/wallets/addresses",
...
describe("legacy multisignature wallet", ({ afterEach, beforeEach, it, nock, assert }) => {
	beforeEach(async (context) => {
		...
		nock.fake("https://btc-test.ardenthq.comcom:443", { encodedQueryParams: true })
			...
			.reply(
				200,
				'{"data":[{"address":"2Mzq2GgWGQShdNr7H2hCxvC6pGrqzb64R3k","txId":"8b4f152b355ad2eedfa471de291b58bc91852e0a7ce9c16e17debf6a0ac89b6c","outputIndex":1,"script":"a914532d3dfa1c6c413a385f216ed2c2b51deb7aeddd87","satoshis":81000},{"address":"2Mzq2GgWGQShdNr7H2hCxvC6pGrqzb64R3k","txId":"002dd704b3df4eaa31abcadd2f60f7b47288d31595f8b83b49d13d64a0a12904","outputIndex":0,"script":"a914532d3dfa1c6c413a385f216ed2c2b51deb7aeddd87","satoshis":100000}],"links":{"first":"https:\\/\\/btc-test.ardenthq.comcom\\/api\\/wallets\\/transactions\\/unspent?page=1","last":"https:\\/\\/btc-teardenthq.comhq.com\\/api\\/wallets\\/transactions\\/unspent?page=1","prev":null,"next":null},"meta":{"current_page":1,"from":1,"last_page":1,"links":[{"url":null,"label":"&laquo; Previous","active":false},{"url":"https:\\/\\/btcardenthq.comenthq.com\\/api\\/wallets\\/transactions\\/unspent?page=1","label":"1","active":true},{"url":null,"label":"Next &raquo;","active":false}],"path":"https:\\/\\/ardenthq.comardenthq.com\\/api\\/wallets\\/transactions\\/unspent","per_page":15,"to":2,"total":2}}',
			)
			.post(
				"/api/wallets/transactions/raw",
	...
	it("should generate a transfer transaction", async (context) => {
		...
		const signedFinal = Psbt.fromBase64(signed2.toBroadcast());
...
describe("p2sh segwit multisignature wallet", ({ afterEach, beforeEach, it, nock, assert }) => {
	beforeEach(async (context) => {
		...
		nock.fake("https://btc-test.ardenthq.comcom:443", { encodedQueryParams: true })
			...
			.reply(
				200,
				'{"data":[{"address":"2Mv8e5hWoFh9X8YdU4e4qCAv7m4wBCz2ytT","txId":"dfa81f23ae409a2b82184c05a8f8bb30d72997e45947577ee2a3e859bc712349","outputIndex":0,"script":"a9141fa993e76d714a6b603abea2361c20c0c7f003bb87","satoshis":98800}],"links":{"first":"https:\\/\\/btc-test.ardenthq.comcom\\/api\\/wallets\\/transactions\\/unspent?page=1","last":"https:\\/\\/btc-teardenthq.comhq.com\\/api\\/wallets\\/transactions\\/unspent?page=1","prev":null,"next":null},"meta":{"current_page":1,"from":1,"last_page":1,"links":[{"url":null,"label":"&laquo; Previous","active":false},{"url":"https:\\/\\/btcardenthq.comenthq.com\\/api\\/wallets\\/transactions\\/unspent?page=1","label":"1","active":true},{"url":null,"label":"Next &raquo;","active":false}],"path":"https:\\/\\/ardenthq.comardenthq.com\\/api\\/wallets\\/transactions\\/unspent","per_page":15,"to":1,"total":1}}',
			)
...
describe("native segwit multisignature wallet", ({ afterEach, beforeEach, it, nock, assert }) => {
	beforeEach(async (context) => {
		...
		nock.fake("https://btc-test.ardenthq.comcom:443", { encodedQueryParams: true })
			...
			.reply(
				200,
				'{"data":[{"address":"tb1qlj3qkv9c5j5gfqgfnqjl0nkwuvw8ktq9u3ahg0du4jnde852nrcstf4cka","txId":"96fd8958fc3d07e73be8adc1888f6fbd1a302df067a3784bdd8ef6e11e1a2afc","outputIndex":1,"script":"0020fca20b30b8a4a88481099825f7cecee31c7b2c05e47b743dbcaca6dc9e8a98f1","satoshis":29400},{"address":"tb1qsyz35zpeueuwmcjap75flg93mny2gn7v3urnnwe4k05rcnvnp4cqq7hew2","txId":"dfa81f23ae409a2b82184c05a8f8bb30d72997e45947577ee2a3e859bc712349","outputIndex":1,"script":"002081051a0839e678ede25d0fa89fa0b1dcc8a44fcc8f0739bb35b3e83c4d930d70","satoshis":200}],"links":{"first":"https:\\/\\/btc-test.ardenthq.comcom\\/api\\/wallets\\/transactions\\/unspent?page=1","last":"https:\\/\\/btc-teardenthq.comhq.com\\/api\\/wallets\\/transactions\\/unspent?page=1","prev":null,"next":null},"meta":{"current_page":1,"from":1,"last_page":1,"links":[{"url":null,"label":"&laquo; Previous","active":false},{"url":"https:\\/\\/btcardenthq.comenthq.com\\/api\\/wallets\\/transactions\\/unspent?page=1","label":"1","active":true},{"url":null,"label":"Next &raquo;","active":false}],"path":"https:\\/\\/ardenthq.comardenthq.com\\/api\\/wallets\\/transactions\\/unspent","per_page":15,"to":2,"total":2}}',
			)
			.post(
				"/api/wallets/transactions/raw",
	...
	it("should succeed", async (context) => {
		...
		const transaction2 = await context.musigService.addSignature(
			...
			new Signatories.Signatory(
				new Signatories.MnemonicSignatory({
					address: "address",
					// @TODO really? We need a way to pass in the account path
					privateKey: "privateKey",
