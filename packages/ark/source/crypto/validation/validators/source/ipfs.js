...
var validate = (function() {
  ...
  var pattern1 = new RegExp('^[123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz]+$');
  var refVal = [];
        ...
        if ((data1 && typeof data1 === "object" && !Array.isArray(data1))) {
          ...
          if (data2 === undefined) {
            ...
            var err = {
              ...
              params: {
                missingProperty: 'ipfs'
              },
              message: 'should have required property \'ipfs\''
            };
            if (vErrors === null) vErrors = [err];
            else vErrors.push(err);
            errors++;
            ...
            var errs_3 = errors;
            if (typeof data2 === "string") {
              if (ucs2length(data2) > 90) {
                var err = {
                  keyword: 'maxLength',
                  dataPath: (dataPath || '') + '.asset.ipfs',
                  schemaPath: '#/properties/asset/properties/ipfs/allOf/0/maxLength',
                  params: {
                    limit: 90
                  },
                  message: 'should NOT be longer than 90 characters'
                };
                if (vErrors === null) vErrors = [err];
                else vErrors.push(err);
                errors++;
