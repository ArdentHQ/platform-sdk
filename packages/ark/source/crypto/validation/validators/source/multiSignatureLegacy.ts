...
const schema47 = { "$id": "multiSignatureLegacy", "else": { "required": ["type", "senderPublicKey", "fee", "amount", "nonce"] }, "if": { "properties": { "version": { "anyOf": [{ "type": "null" }, { "const": 1 }] } } }, "properties": { "amount": { "bignumber": { "minimum": 0, "maximum": 0 } }, "fee": { "bignumber": { "minimum": 1 } }, "id": { "type": "string" }, "network": { "$ref": "networkByte" }, "nonce": { "bignumber": { "minimum": 0 } }, "secondSignature": { "type": "string" }, "senderPublicKey": { "type": "string" }, "signSignature": { "type": "string" }, "signature": { "type": "string" }, "version": { "enum": [1, 2], "anyOf": [{ "type": "null" }, { "const": 1 }] }, "timestamp": { "type": "integer", "minimum": 0 }, "typeGroup": { "minimum": 0, "type": "integer" }, "asset": { "properties": { "multiSignatureLegacy": { "properties": { "lifetime": { "minimum": 1, "type": "integer", "maximum": 72 }, "keysgroup": { "minItems": 1, "type": "array", "maxItems": 16, "items": { "allOf": [{ "minimum": 67, "type": "string", "maximum": 67 }] } }, "min": { "type": "integer", "minimum": 1, "maximum": { "$data": "1/keysgroup/length" } } }, "required": ["keysgroup", "min", "lifetime"], "type": "object" } }, "required": ["multiSignatureLegacy"], "type": "object" }, "signatures": { "items": { "type": "string" }, "maxItems": 1, "minItems": 1, "type": "array" }, "type": { "transactionType": 4 } }, "then": { "required": ["type", "senderPublicKey", "fee", "amount", "timestamp"] }, "type": "object", "required": ["asset"] };
function validate33(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { /*# sourceURL="multiSignatureLegacy" */ ; let vErrors = null; let errors = 0; const _errs1 = errors; let valid0 = true; const _errs2 = errors; if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.secondSignature !== undefined) {
        ...
        if (typeof data6 !== "string") {
            const err16 = { instancePath: instancePath + "/secondSignature", schemaPath: "#/properties/secondSignature/type", keyword: "type", params: { type: "string" }, message: "must be string", schema: schema47.properties.secondSignature.type, parentSchema: schema47.properties.secondSignature, data: data6 };
            if (vErrors === null) {
                vErrors = [err16];
            }
            else {
    ...
    if (data.version !== undefined) {
        ...
        if (data10 !== null) {
            const err21 = { instancePath: instancePath + "/version", schemaPath: "#/properties/version/anyOf/0/type", keyword: "type", params: { type: "null" }, message: "must be null", schema: schema47.properties.version.anyOf[0].type, parentSchema: schema47.properties.version.anyOf[0], data: data10 };
            if (vErrors === null) {
                vErrors = [err21];
            }
            else {
        ...
        if (!valid5) {
            ...
            if (1 !== data10) {
                const err22 = { instancePath: instancePath + "/version", schemaPath: "#/properties/version/anyOf/1/const", keyword: "const", params: { allowedValue: 1 }, message: "must be equal to constant", schema: 1, parentSchema: schema47.properties.version.anyOf[1], data: data10 };
                if (vErrors === null) {
                    vErrors = [err22];
                }
                else {
        ...
        if (!valid5) {
            const err23 = { instancePath: instancePath + "/version", schemaPath: "#/properties/version/anyOf", keyword: "anyOf", params: {}, message: "must match a schema in anyOf", schema: schema47.properties.version.anyOf, parentSchema: schema47.properties.version, data: data10 };
            if (vErrors === null) {
                vErrors = [err23];
            }
            else {
    ...
    if (data.timestamp !== undefined) {
        ...
        if (!(((typeof data11 == "number") && (!(data11 % 1) && !isNaN(data11))) && (isFinite(data11)))) {
            const err24 = { instancePath: instancePath + "/timestamp", schemaPath: "#/properties/timestamp/type", keyword: "type", params: { type: "integer" }, message: "must be integer", schema: schema47.properties.timestamp.type, parentSchema: schema47.properties.timestamp, data: data11 };
            if (vErrors === null) {
                vErrors = [err24];
            }
            else {
        ...
        if ((typeof data11 == "number") && (isFinite(data11))) {
            if (data11 < 0 || isNaN(data11)) {
                const err25 = { instancePath: instancePath + "/timestamp", schemaPath: "#/properties/timestamp/minimum", keyword: "minimum", params: { comparison: ">=", limit: 0 }, message: "must be >= 0", schema: 0, parentSchema: schema47.properties.timestamp, data: data11 };
                if (vErrors === null) {
                    vErrors = [err25];
                }
                else {
    ...
    if (data.typeGroup !== undefined) {
        ...
        if (!(((typeof data12 == "number") && (!(data12 % 1) && !isNaN(data12))) && (isFinite(data12)))) {
            const err26 = { instancePath: instancePath + "/typeGroup", schemaPath: "#/properties/typeGroup/type", keyword: "type", params: { type: "integer" }, message: "must be integer", schema: schema47.properties.typeGroup.type, parentSchema: schema47.properties.typeGroup, data: data12 };
            if (vErrors === null) {
                vErrors = [err26];
            }
            else {
        ...
        if ((typeof data12 == "number") && (isFinite(data12))) {
            if (data12 < 0 || isNaN(data12)) {
                const err27 = { instancePath: instancePath + "/typeGroup", schemaPath: "#/properties/typeGroup/minimum", keyword: "minimum", params: { comparison: ">=", limit: 0 }, message: "must be >= 0", schema: 0, parentSchema: schema47.properties.typeGroup, data: data12 };
                if (vErrors === null) {
                    vErrors = [err27];
                }
                else {
    ...
    if (data.asset !== undefined) {
        ...
        if (data13 && typeof data13 == "object" && !Array.isArray(data13)) {
            if (data13.multiSignatureLegacy === undefined) {
                const err28 = { instancePath: instancePath + "/asset", schemaPath: "#/properties/asset/required", keyword: "required", params: { missingProperty: "multiSignatureLegacy" }, message: "must have required property '" + "multiSignatureLegacy" + "'", schema: schema47.properties.asset.required, parentSchema: schema47.properties.asset, data: data13 };
                if (vErrors === null) {
                    vErrors = [err28];
                }
                else {
                    ...
                    if (data14.lifetime !== undefined) {
                        ...
                        if ((typeof data15 == "number") && (isFinite(data15))) {
                            if (data15 > 72 || isNaN(data15)) {
                                const err33 = { instancePath: instancePath + "/asset/multiSignatureLegacy/lifetime", schemaPath: "#/properties/asset/properties/multiSignatureLegacy/properties/lifetime/maximum", keyword: "maximum", params: { comparison: "<=", limit: 72 }, message: "must be <= 72", schema: 72, parentSchema: schema47.properties.asset.properties.multiSignatureLegacy.properties.lifetime, data: data15 };
                                if (vErrors === null) {
                                    vErrors = [err33];
                                }
                                else {
                            ...
                            if (data15 < 1 || isNaN(data15)) {
                                const err34 = { instancePath: instancePath + "/asset/multiSignatureLegacy/lifetime", schemaPath: "#/properties/asset/properties/multiSignatureLegacy/properties/lifetime/minimum", keyword: "minimum", params: { comparison: ">=", limit: 1 }, message: "must be >= 1", schema: 1, parentSchema: schema47.properties.asset.properties.multiSignatureLegacy.properties.lifetime, data: data15 };
                                if (vErrors === null) {
                                    vErrors = [err34];
                                }
                                else {
                    ...
                    if (data14.min !== undefined) {
                        ...
                        if ((typeof data18 == "number") && (isFinite(data18))) {
                            ...
                            if (vSchema1 !== undefined && ((!((typeof vSchema1 == "number") && (isFinite(vSchema1)))) || (data18 > vSchema1 || isNaN(data18)))) {
                                const err42 = { instancePath: instancePath + "/asset/multiSignatureLegacy/min", schemaPath: "#/properties/asset/properties/multiSignatureLegacy/properties/min/maximum", keyword: "maximum", params: { comparison: "<=", limit: vSchema1 }, message: "must be <= " + vSchema1, schema: schema47.properties.asset.properties.multiSignatureLegacy.properties.min.maximum, parentSchema: schema47.properties.asset.properties.multiSignatureLegacy.properties.min, data: data18 };
                                if (vErrors === null) {
                                    vErrors = [err42];
                                }
                                else {
                            ...
                            if (data18 < 1 || isNaN(data18)) {
                                const err43 = { instancePath: instancePath + "/asset/multiSignatureLegacy/min", schemaPath: "#/properties/asset/properties/multiSignatureLegacy/properties/min/minimum", keyword: "minimum", params: { comparison: ">=", limit: 1 }, message: "must be >= 1", schema: 1, parentSchema: schema47.properties.asset.properties.multiSignatureLegacy.properties.min, data: data18 };
                                if (vErrors === null) {
                                    vErrors = [err43];
                                }
                                else {
            ...
            const err45 = { instancePath: instancePath + "/asset", schemaPath: "#/properties/asset/type", keyword: "type", params: { type: "object" }, message: "must be object", schema: schema47.properties.asset.type, parentSchema: schema47.properties.asset, data: data13 };
            if (vErrors === null) {
                vErrors = [err45];
            }
            else {
    ...
    if (data.signatures !== undefined) {
        ...
        if (Array.isArray(data19)) {
            if (data19.length > 1) {
                const err46 = { instancePath: instancePath + "/signatures", schemaPath: "#/properties/signatures/maxItems", keyword: "maxItems", params: { limit: 1 }, message: "must NOT have more than 1 items", schema: 1, parentSchema: schema47.properties.signatures, data: data19 };
                if (vErrors === null) {
                    vErrors = [err46];
                }
                else {
            ...
            if (data19.length < 1) {
                const err47 = { instancePath: instancePath + "/signatures", schemaPath: "#/properties/signatures/minItems", keyword: "minItems", params: { limit: 1 }, message: "must NOT have fewer than 1 items", schema: 1, parentSchema: schema47.properties.signatures, data: data19 };
                if (vErrors === null) {
                    vErrors = [err47];
                }
                else {
            ...
            for (let i1 = 0; i1 < len1; i1++) {
                ...
                if (typeof data20 !== "string") {
                    const err48 = { instancePath: instancePath + "/signatures/" + i1, schemaPath: "#/properties/signatures/items/type", keyword: "type", params: { type: "string" }, message: "must be string", schema: schema47.properties.signatures.items.type, parentSchema: schema47.properties.signatures.items, data: data20 };
                    if (vErrors === null) {
                        vErrors = [err48];
                    }
                    else {
            ...
            const err49 = { instancePath: instancePath + "/signatures", schemaPath: "#/properties/signatures/type", keyword: "type", params: { type: "array" }, message: "must be array", schema: schema47.properties.signatures.type, parentSchema: schema47.properties.signatures, data: data19 };
            if (vErrors === null) {
                vErrors = [err49];
            }
            else {
    ...
    const err50 = { instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" }, message: "must be object", schema: schema47.type, parentSchema: schema47, data };
    if (vErrors === null) {
        vErrors = [err50];
    }
    else {
...
const schema49 = { "$id": "multiSignatureLegacyStrict", "else": { "required": ["type", "senderPublicKey", "fee", "amount", "nonce"] }, "if": { "properties": { "version": { "anyOf": [{ "type": "null" }, { "const": 1 }] } } }, "properties": { "amount": { "bignumber": { "minimum": 0, "maximum": 0 } }, "fee": { "bignumber": { "minimum": 1 } }, "id": { "type": "string" }, "network": { "$ref": "networkByte" }, "nonce": { "bignumber": { "minimum": 0 } }, "secondSignature": { "type": "string" }, "senderPublicKey": { "type": "string" }, "signSignature": { "type": "string" }, "signature": { "type": "string" }, "version": { "enum": [1, 2], "anyOf": [{ "type": "null" }, { "const": 1 }] }, "timestamp": { "type": "integer", "minimum": 0 }, "typeGroup": { "minimum": 0, "type": "integer" }, "asset": { "properties": { "multiSignatureLegacy": { "properties": { "lifetime": { "minimum": 1, "type": "integer", "maximum": 72 }, "keysgroup": { "minItems": 1, "type": "array", "maxItems": 16, "items": { "allOf": [{ "minimum": 67, "type": "string", "maximum": 67 }] } }, "min": { "type": "integer", "minimum": 1, "maximum": { "$data": "1/keysgroup/length" } } }, "required": ["keysgroup", "min", "lifetime"], "type": "object" } }, "required": ["multiSignatureLegacy"], "type": "object" }, "signatures": { "items": { "type": "string" }, "maxItems": 1, "minItems": 1, "type": "array" }, "type": { "transactionType": 4 } }, "then": { "required": ["type", "senderPublicKey", "fee", "amount", "timestamp"] }, "type": "object", "required": ["asset"], "anyOf": [{ "required": ["id", "signature"] }, { "required": ["id", "signature", "signatures"] }, { "required": ["id", "signatures"] }], "additionalProperties": false };
const func2 = Object.prototype.hasOwnProperty;
function validate34(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { /*# sourceURL="multiSignatureLegacyStrict" */ ; let vErrors = null; let errors = 0; const _errs1 = errors; let valid0 = false; const _errs2 = errors; if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.id === undefined) {
    ...
    if (data.secondSignature !== undefined) {
        let data6 = data.secondSignature;
        if (typeof data6 !== "string") {
            const err25 = { instancePath: instancePath + "/secondSignature", schemaPath: "#/properties/secondSignature/type", keyword: "type", params: { type: "string" }, message: "must be string", schema: schema49.properties.secondSignature.type, parentSchema: schema49.properties.secondSignature, data: data6 };
            if (vErrors === null) {
                vErrors = [err25];
            }
            else {
    ...
    if (data.version !== undefined) {
        ...
        if (data10 !== null) {
            const err30 = { instancePath: instancePath + "/version", schemaPath: "#/properties/version/anyOf/0/type", keyword: "type", params: { type: "null" }, message: "must be null", schema: schema49.properties.version.anyOf[0].type, parentSchema: schema49.properties.version.anyOf[0], data: data10 };
            if (vErrors === null) {
                vErrors = [err30];
            }
            else {
        ...
        if (!valid6) {
            ...
            if (1 !== data10) {
                const err31 = { instancePath: instancePath + "/version", schemaPath: "#/properties/version/anyOf/1/const", keyword: "const", params: { allowedValue: 1 }, message: "must be equal to constant", schema: 1, parentSchema: schema49.properties.version.anyOf[1], data: data10 };
                if (vErrors === null) {
                    vErrors = [err31];
                }
                else {
        ...
        if (!valid6) {
            const err32 = { instancePath: instancePath + "/version", schemaPath: "#/properties/version/anyOf", keyword: "anyOf", params: {}, message: "must match a schema in anyOf", schema: schema49.properties.version.anyOf, parentSchema: schema49.properties.version, data: data10 };
            if (vErrors === null) {
                vErrors = [err32];
            }
            else {
    ...
    if (data.timestamp !== undefined) {
        let data11 = data.timestamp;
        if (!(((typeof data11 == "number") && (!(data11 % 1) && !isNaN(data11))) && (isFinite(data11)))) {
            const err33 = { instancePath: instancePath + "/timestamp", schemaPath: "#/properties/timestamp/type", keyword: "type", params: { type: "integer" }, message: "must be integer", schema: schema49.properties.timestamp.type, parentSchema: schema49.properties.timestamp, data: data11 };
            if (vErrors === null) {
                vErrors = [err33];
            }
            else {
        ...
        if ((typeof data11 == "number") && (isFinite(data11))) {
            if (data11 < 0 || isNaN(data11)) {
                const err34 = { instancePath: instancePath + "/timestamp", schemaPath: "#/properties/timestamp/minimum", keyword: "minimum", params: { comparison: ">=", limit: 0 }, message: "must be >= 0", schema: 0, parentSchema: schema49.properties.timestamp, data: data11 };
                if (vErrors === null) {
                    vErrors = [err34];
                }
                else {
    ...
    if (data.typeGroup !== undefined) {
        let data12 = data.typeGroup;
        if (!(((typeof data12 == "number") && (!(data12 % 1) && !isNaN(data12))) && (isFinite(data12)))) {
            const err35 = { instancePath: instancePath + "/typeGroup", schemaPath: "#/properties/typeGroup/type", keyword: "type", params: { type: "integer" }, message: "must be integer", schema: schema49.properties.typeGroup.type, parentSchema: schema49.properties.typeGroup, data: data12 };
            if (vErrors === null) {
                vErrors = [err35];
            }
            else {
        ...
        if ((typeof data12 == "number") && (isFinite(data12))) {
            if (data12 < 0 || isNaN(data12)) {
                const err36 = { instancePath: instancePath + "/typeGroup", schemaPath: "#/properties/typeGroup/minimum", keyword: "minimum", params: { comparison: ">=", limit: 0 }, message: "must be >= 0", schema: 0, parentSchema: schema49.properties.typeGroup, data: data12 };
                if (vErrors === null) {
                    vErrors = [err36];
                }
                else {
    ...
    if (data.asset !== undefined) {
        ...
        if (data13 && typeof data13 == "object" && !Array.isArray(data13)) {
            if (data13.multiSignatureLegacy === undefined) {
                const err37 = { instancePath: instancePath + "/asset", schemaPath: "#/properties/asset/required", keyword: "required", params: { missingProperty: "multiSignatureLegacy" }, message: "must have required property '" + "multiSignatureLegacy" + "'", schema: schema49.properties.asset.required, parentSchema: schema49.properties.asset, data: data13 };
                if (vErrors === null) {
                    vErrors = [err37];
                }
                else {
            ...
            if (data13.multiSignatureLegacy !== undefined) {
                ...
                if (data14 && typeof data14 == "object" && !Array.isArray(data14)) {
                    if (data14.keysgroup === undefined) {
                        const err38 = { instancePath: instancePath + "/asset/multiSignatureLegacy", schemaPath: "#/properties/asset/properties/multiSignatureLegacy/required", keyword: "required", params: { missingProperty: "keysgroup" }, message: "must have required property '" + "keysgroup" + "'", schema: schema49.properties.asset.properties.multiSignatureLegacy.required, parentSchema: schema49.properties.asset.properties.multiSignatureLegacy, data: data14 };
                        if (vErrors === null) {
                            vErrors = [err38];
                        }
                        else {
                    ...
                    if (data14.lifetime === undefined) {
                        const err40 = { instancePath: instancePath + "/asset/multiSignatureLegacy", schemaPath: "#/properties/asset/properties/multiSignatureLegacy/required", keyword: "required", params: { missingProperty: "lifetime" }, message: "must have required property '" + "lifetime" + "'", schema: schema49.properties.asset.properties.multiSignatureLegacy.required, parentSchema: schema49.properties.asset.properties.multiSignatureLegacy, data: data14 };
                        if (vErrors === null) {
                            vErrors = [err40];
                        }
                        else {
                    ...
                    if (data14.lifetime !== undefined) {
                        ...
                        if ((typeof data15 == "number") && (isFinite(data15))) {
                            if (data15 > 72 || isNaN(data15)) {
                                const err42 = { instancePath: instancePath + "/asset/multiSignatureLegacy/lifetime", schemaPath: "#/properties/asset/properties/multiSignatureLegacy/properties/lifetime/maximum", keyword: "maximum", params: { comparison: "<=", limit: 72 }, message: "must be <= 72", schema: 72, parentSchema: schema49.properties.asset.properties.multiSignatureLegacy.properties.lifetime, data: data15 };
                                if (vErrors === null) {
                                    vErrors = [err42];
                                }
                                else {
                            ...
                            if (data15 < 1 || isNaN(data15)) {
                                const err43 = { instancePath: instancePath + "/asset/multiSignatureLegacy/lifetime", schemaPath: "#/properties/asset/properties/multiSignatureLegacy/properties/lifetime/minimum", keyword: "minimum", params: { comparison: ">=", limit: 1 }, message: "must be >= 1", schema: 1, parentSchema: schema49.properties.asset.properties.multiSignatureLegacy.properties.lifetime, data: data15 };
                                if (vErrors === null) {
                                    vErrors = [err43];
                                }
                                else {
                    ...
                    if (data14.keysgroup !== undefined) {
                        ...
                        if (Array.isArray(data16)) {
                            ...
                            if (data16.length < 1) {
                                const err45 = { instancePath: instancePath + "/asset/multiSignatureLegacy/keysgroup", schemaPath: "#/properties/asset/properties/multiSignatureLegacy/properties/keysgroup/minItems", keyword: "minItems", params: { limit: 1 }, message: "must NOT have fewer than 1 items", schema: 1, parentSchema: schema49.properties.asset.properties.multiSignatureLegacy.properties.keysgroup, data: data16 };
                                if (vErrors === null) {
                                    vErrors = [err45];
                                }
                                else {
                            ...
                            for (let i0 = 0; i0 < len0; i0++) {
                                ...
                                if ((typeof data17 == "number") && (isFinite(data17))) {
                                    if (data17 > 67 || isNaN(data17)) {
                                        const err47 = { instancePath: instancePath + "/asset/multiSignatureLegacy/keysgroup/" + i0, schemaPath: "#/properties/asset/properties/multiSignatureLegacy/properties/keysgroup/items/allOf/0/maximum", keyword: "maximum", params: { comparison: "<=", limit: 67 }, message: "must be <= 67", schema: 67, parentSchema: schema49.properties.asset.properties.multiSignatureLegacy.properties.keysgroup.items.allOf[0], data: data17 };
                                        if (vErrors === null) {
                                            vErrors = [err47];
                                        }
                                        else {
                    ...
                    if (data14.min !== undefined) {
                        ...
                        if ((typeof data18 == "number") && (isFinite(data18))) {
                            const vSchema1 = data14 && data14.keysgroup && data14.keysgroup.length;
                            if (vSchema1 !== undefined && ((!((typeof vSchema1 == "number") && (isFinite(vSchema1)))) || (data18 > vSchema1 || isNaN(data18)))) {
                                const err51 = { instancePath: instancePath + "/asset/multiSignatureLegacy/min", schemaPath: "#/properties/asset/properties/multiSignatureLegacy/properties/min/maximum", keyword: "maximum", params: { comparison: "<=", limit: vSchema1 }, message: "must be <= " + vSchema1, schema: schema49.properties.asset.properties.multiSignatureLegacy.properties.min.maximum, parentSchema: schema49.properties.asset.properties.multiSignatureLegacy.properties.min, data: data18 };
                                if (vErrors === null) {
                                    vErrors = [err51];
                                }
                                else {
                            ...
                            if (data18 < 1 || isNaN(data18)) {
                                const err52 = { instancePath: instancePath + "/asset/multiSignatureLegacy/min", schemaPath: "#/properties/asset/properties/multiSignatureLegacy/properties/min/minimum", keyword: "minimum", params: { comparison: ">=", limit: 1 }, message: "must be >= 1", schema: 1, parentSchema: schema49.properties.asset.properties.multiSignatureLegacy.properties.min, data: data18 };
                                if (vErrors === null) {
                                    vErrors = [err52];
                                }
                                else {
            ...
            const err54 = { instancePath: instancePath + "/asset", schemaPath: "#/properties/asset/type", keyword: "type", params: { type: "object" }, message: "must be object", schema: schema49.properties.asset.type, parentSchema: schema49.properties.asset, data: data13 };
            if (vErrors === null) {
                vErrors = [err54];
            }
            else {
    ...
    if (data.signatures !== undefined) {
        ...
        if (Array.isArray(data19)) {
            if (data19.length > 1) {
                const err55 = { instancePath: instancePath + "/signatures", schemaPath: "#/properties/signatures/maxItems", keyword: "maxItems", params: { limit: 1 }, message: "must NOT have more than 1 items", schema: 1, parentSchema: schema49.properties.signatures, data: data19 };
                if (vErrors === null) {
                    vErrors = [err55];
                }
                else {
            ...
            if (data19.length < 1) {
                const err56 = { instancePath: instancePath + "/signatures", schemaPath: "#/properties/signatures/minItems", keyword: "minItems", params: { limit: 1 }, message: "must NOT have fewer than 1 items", schema: 1, parentSchema: schema49.properties.signatures, data: data19 };
                if (vErrors === null) {
                    vErrors = [err56];
                }
                else {
            ...
            for (let i1 = 0; i1 < len1; i1++) {
                let data20 = data19[i1];
                if (typeof data20 !== "string") {
                    const err57 = { instancePath: instancePath + "/signatures/" + i1, schemaPath: "#/properties/signatures/items/type", keyword: "type", params: { type: "string" }, message: "must be string", schema: schema49.properties.signatures.items.type, parentSchema: schema49.properties.signatures.items, data: data20 };
                    if (vErrors === null) {
                        vErrors = [err57];
                    }
                    else {
            ...
            const err58 = { instancePath: instancePath + "/signatures", schemaPath: "#/properties/signatures/type", keyword: "type", params: { type: "array" }, message: "must be array", schema: schema49.properties.signatures.type, parentSchema: schema49.properties.signatures, data: data19 };
            if (vErrors === null) {
                vErrors = [err58];
            }
            else {
    ...
    const err59 = { instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" }, message: "must be object", schema: schema49.type, parentSchema: schema49, data };
    if (vErrors === null) {
        vErrors = [err59];
    }
    else {
...
const schema51 = { "$id": "multiSignatureLegacySigned", "else": { "required": ["type", "senderPublicKey", "fee", "amount", "nonce"] }, "if": { "properties": { "version": { "anyOf": [{ "type": "null" }, { "const": 1 }] } } }, "properties": { "amount": { "bignumber": { "minimum": 0, "maximum": 0 } }, "fee": { "bignumber": { "minimum": 1 } }, "id": { "type": "string" }, "network": { "$ref": "networkByte" }, "nonce": { "bignumber": { "minimum": 0 } }, "secondSignature": { "type": "string" }, "senderPublicKey": { "type": "string" }, "signSignature": { "type": "string" }, "signature": { "type": "string" }, "version": { "enum": [1, 2], "anyOf": [{ "type": "null" }, { "const": 1 }] }, "timestamp": { "type": "integer", "minimum": 0 }, "typeGroup": { "minimum": 0, "type": "integer" }, "asset": { "properties": { "multiSignatureLegacy": { "properties": { "lifetime": { "minimum": 1, "type": "integer", "maximum": 72 }, "keysgroup": { "minItems": 1, "type": "array", "maxItems": 16, "items": { "allOf": [{ "minimum": 67, "type": "string", "maximum": 67 }] } }, "min": { "type": "integer", "minimum": 1, "maximum": { "$data": "1/keysgroup/length" } } }, "required": ["keysgroup", "min", "lifetime"], "type": "object" } }, "required": ["multiSignatureLegacy"], "type": "object" }, "signatures": { "items": { "type": "string" }, "maxItems": 1, "minItems": 1, "type": "array" }, "type": { "transactionType": 4 } }, "then": { "required": ["type", "senderPublicKey", "fee", "amount", "timestamp"] }, "type": "object", "required": ["asset"], "anyOf": [{ "required": ["id", "signature"] }, { "required": ["id", "signature", "signatures"] }, { "required": ["id", "signatures"] }] };
function validate35(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { /*# sourceURL="multiSignatureLegacySigned" */ ; let vErrors = null; let errors = 0; const _errs1 = errors; let valid0 = false; const _errs2 = errors; if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.id === undefined) {
    ...
    if (data.secondSignature !== undefined) {
        let data6 = data.secondSignature;
        if (typeof data6 !== "string") {
            const err24 = { instancePath: instancePath + "/secondSignature", schemaPath: "#/properties/secondSignature/type", keyword: "type", params: { type: "string" }, message: "must be string", schema: schema51.properties.secondSignature.type, parentSchema: schema51.properties.secondSignature, data: data6 };
            if (vErrors === null) {
                vErrors = [err24];
            }
            else {
    ...
    if (data.version !== undefined) {
        ...
        const _errs31 = errors;
        if (data10 !== null) {
            const err29 = { instancePath: instancePath + "/version", schemaPath: "#/properties/version/anyOf/0/type", keyword: "type", params: { type: "null" }, message: "must be null", schema: schema51.properties.version.anyOf[0].type, parentSchema: schema51.properties.version.anyOf[0], data: data10 };
            if (vErrors === null) {
                vErrors = [err29];
            }
            else {
        ...
        if (!valid6) {
            ...
            if (1 !== data10) {
                const err30 = { instancePath: instancePath + "/version", schemaPath: "#/properties/version/anyOf/1/const", keyword: "const", params: { allowedValue: 1 }, message: "must be equal to constant", schema: 1, parentSchema: schema51.properties.version.anyOf[1], data: data10 };
                if (vErrors === null) {
                    vErrors = [err30];
                }
                else {
        ...
        if (!valid6) {
            const err31 = { instancePath: instancePath + "/version", schemaPath: "#/properties/version/anyOf", keyword: "anyOf", params: {}, message: "must match a schema in anyOf", schema: schema51.properties.version.anyOf, parentSchema: schema51.properties.version, data: data10 };
            if (vErrors === null) {
                vErrors = [err31];
            }
            else {
    ...
    if (data.timestamp !== undefined) {
        let data11 = data.timestamp;
        if (!(((typeof data11 == "number") && (!(data11 % 1) && !isNaN(data11))) && (isFinite(data11)))) {
            const err32 = { instancePath: instancePath + "/timestamp", schemaPath: "#/properties/timestamp/type", keyword: "type", params: { type: "integer" }, message: "must be integer", schema: schema51.properties.timestamp.type, parentSchema: schema51.properties.timestamp, data: data11 };
            if (vErrors === null) {
                vErrors = [err32];
            }
            else {
        ...
        if ((typeof data11 == "number") && (isFinite(data11))) {
            if (data11 < 0 || isNaN(data11)) {
                const err33 = { instancePath: instancePath + "/timestamp", schemaPath: "#/properties/timestamp/minimum", keyword: "minimum", params: { comparison: ">=", limit: 0 }, message: "must be >= 0", schema: 0, parentSchema: schema51.properties.timestamp, data: data11 };
                if (vErrors === null) {
                    vErrors = [err33];
                }
                else {
    ...
    if (data.typeGroup !== undefined) {
        let data12 = data.typeGroup;
        if (!(((typeof data12 == "number") && (!(data12 % 1) && !isNaN(data12))) && (isFinite(data12)))) {
            const err34 = { instancePath: instancePath + "/typeGroup", schemaPath: "#/properties/typeGroup/type", keyword: "type", params: { type: "integer" }, message: "must be integer", schema: schema51.properties.typeGroup.type, parentSchema: schema51.properties.typeGroup, data: data12 };
            if (vErrors === null) {
                vErrors = [err34];
            }
            else {
        ...
        if ((typeof data12 == "number") && (isFinite(data12))) {
            if (data12 < 0 || isNaN(data12)) {
                const err35 = { instancePath: instancePath + "/typeGroup", schemaPath: "#/properties/typeGroup/minimum", keyword: "minimum", params: { comparison: ">=", limit: 0 }, message: "must be >= 0", schema: 0, parentSchema: schema51.properties.typeGroup, data: data12 };
                if (vErrors === null) {
                    vErrors = [err35];
                }
                else {
    ...
    if (data.asset !== undefined) {
        ...
        if (data13 && typeof data13 == "object" && !Array.isArray(data13)) {
            if (data13.multiSignatureLegacy === undefined) {
                const err36 = { instancePath: instancePath + "/asset", schemaPath: "#/properties/asset/required", keyword: "required", params: { missingProperty: "multiSignatureLegacy" }, message: "must have required property '" + "multiSignatureLegacy" + "'", schema: schema51.properties.asset.required, parentSchema: schema51.properties.asset, data: data13 };
                if (vErrors === null) {
                    vErrors = [err36];
                }
                else {
            ...
            if (data13.multiSignatureLegacy !== undefined) {
                ...
                if (data14 && typeof data14 == "object" && !Array.isArray(data14)) {
                    if (data14.keysgroup === undefined) {
                        const err37 = { instancePath: instancePath + "/asset/multiSignatureLegacy", schemaPath: "#/properties/asset/properties/multiSignatureLegacy/required", keyword: "required", params: { missingProperty: "keysgroup" }, message: "must have required property '" + "keysgroup" + "'", schema: schema51.properties.asset.properties.multiSignatureLegacy.required, parentSchema: schema51.properties.asset.properties.multiSignatureLegacy, data: data14 };
                        if (vErrors === null) {
                            vErrors = [err37];
                        }
                        else {
                    ...
                    if (data14.lifetime === undefined) {
                        const err39 = { instancePath: instancePath + "/asset/multiSignatureLegacy", schemaPath: "#/properties/asset/properties/multiSignatureLegacy/required", keyword: "required", params: { missingProperty: "lifetime" }, message: "must have required property '" + "lifetime" + "'", schema: schema51.properties.asset.properties.multiSignatureLegacy.required, parentSchema: schema51.properties.asset.properties.multiSignatureLegacy, data: data14 };
                        if (vErrors === null) {
                            vErrors = [err39];
                        }
                        else {
                    ...
                    if (data14.lifetime !== undefined) {
                        ...
                        if ((typeof data15 == "number") && (isFinite(data15))) {
                            if (data15 > 72 || isNaN(data15)) {
                                const err41 = { instancePath: instancePath + "/asset/multiSignatureLegacy/lifetime", schemaPath: "#/properties/asset/properties/multiSignatureLegacy/properties/lifetime/maximum", keyword: "maximum", params: { comparison: "<=", limit: 72 }, message: "must be <= 72", schema: 72, parentSchema: schema51.properties.asset.properties.multiSignatureLegacy.properties.lifetime, data: data15 };
                                if (vErrors === null) {
                                    vErrors = [err41];
                                }
                                else {
                            ...
                            if (data15 < 1 || isNaN(data15)) {
                                const err42 = { instancePath: instancePath + "/asset/multiSignatureLegacy/lifetime", schemaPath: "#/properties/asset/properties/multiSignatureLegacy/properties/lifetime/minimum", keyword: "minimum", params: { comparison: ">=", limit: 1 }, message: "must be >= 1", schema: 1, parentSchema: schema51.properties.asset.properties.multiSignatureLegacy.properties.lifetime, data: data15 };
                                if (vErrors === null) {
                                    vErrors = [err42];
                                }
                                else {
                    ...
                    if (data14.keysgroup !== undefined) {
                        ...
                        if (Array.isArray(data16)) {
                            ...
                            if (data16.length < 1) {
                                const err44 = { instancePath: instancePath + "/asset/multiSignatureLegacy/keysgroup", schemaPath: "#/properties/asset/properties/multiSignatureLegacy/properties/keysgroup/minItems", keyword: "minItems", params: { limit: 1 }, message: "must NOT have fewer than 1 items", schema: 1, parentSchema: schema51.properties.asset.properties.multiSignatureLegacy.properties.keysgroup, data: data16 };
                                if (vErrors === null) {
                                    vErrors = [err44];
                                }
                                else {
                            ...
                            for (let i0 = 0; i0 < len0; i0++) {
                                ...
                                if ((typeof data17 == "number") && (isFinite(data17))) {
                                    if (data17 > 67 || isNaN(data17)) {
                                        const err46 = { instancePath: instancePath + "/asset/multiSignatureLegacy/keysgroup/" + i0, schemaPath: "#/properties/asset/properties/multiSignatureLegacy/properties/keysgroup/items/allOf/0/maximum", keyword: "maximum", params: { comparison: "<=", limit: 67 }, message: "must be <= 67", schema: 67, parentSchema: schema51.properties.asset.properties.multiSignatureLegacy.properties.keysgroup.items.allOf[0], data: data17 };
                                        if (vErrors === null) {
                                            vErrors = [err46];
                                        }
                                        else {
                    ...
                    if (data14.min !== undefined) {
                        ...
                        if ((typeof data18 == "number") && (isFinite(data18))) {
                            const vSchema1 = data14 && data14.keysgroup && data14.keysgroup.length;
                            if (vSchema1 !== undefined && ((!((typeof vSchema1 == "number") && (isFinite(vSchema1)))) || (data18 > vSchema1 || isNaN(data18)))) {
                                const err50 = { instancePath: instancePath + "/asset/multiSignatureLegacy/min", schemaPath: "#/properties/asset/properties/multiSignatureLegacy/properties/min/maximum", keyword: "maximum", params: { comparison: "<=", limit: vSchema1 }, message: "must be <= " + vSchema1, schema: schema51.properties.asset.properties.multiSignatureLegacy.properties.min.maximum, parentSchema: schema51.properties.asset.properties.multiSignatureLegacy.properties.min, data: data18 };
                                if (vErrors === null) {
                                    vErrors = [err50];
                                }
                                else {
                            ...
                            if (data18 < 1 || isNaN(data18)) {
                                const err51 = { instancePath: instancePath + "/asset/multiSignatureLegacy/min", schemaPath: "#/properties/asset/properties/multiSignatureLegacy/properties/min/minimum", keyword: "minimum", params: { comparison: ">=", limit: 1 }, message: "must be >= 1", schema: 1, parentSchema: schema51.properties.asset.properties.multiSignatureLegacy.properties.min, data: data18 };
                                if (vErrors === null) {
                                    vErrors = [err51];
                                }
                                else {
            ...
            const err53 = { instancePath: instancePath + "/asset", schemaPath: "#/properties/asset/type", keyword: "type", params: { type: "object" }, message: "must be object", schema: schema51.properties.asset.type, parentSchema: schema51.properties.asset, data: data13 };
            if (vErrors === null) {
                vErrors = [err53];
            }
            else {
    ...
    if (data.signatures !== undefined) {
        ...
        if (Array.isArray(data19)) {
            if (data19.length > 1) {
                const err54 = { instancePath: instancePath + "/signatures", schemaPath: "#/properties/signatures/maxItems", keyword: "maxItems", params: { limit: 1 }, message: "must NOT have more than 1 items", schema: 1, parentSchema: schema51.properties.signatures, data: data19 };
                if (vErrors === null) {
                    vErrors = [err54];
                }
                else {
            ...
            if (data19.length < 1) {
                const err55 = { instancePath: instancePath + "/signatures", schemaPath: "#/properties/signatures/minItems", keyword: "minItems", params: { limit: 1 }, message: "must NOT have fewer than 1 items", schema: 1, parentSchema: schema51.properties.signatures, data: data19 };
                if (vErrors === null) {
                    vErrors = [err55];
                }
                else {
            ...
            for (let i1 = 0; i1 < len1; i1++) {
                let data20 = data19[i1];
                if (typeof data20 !== "string") {
                    const err56 = { instancePath: instancePath + "/signatures/" + i1, schemaPath: "#/properties/signatures/items/type", keyword: "type", params: { type: "string" }, message: "must be string", schema: schema51.properties.signatures.items.type, parentSchema: schema51.properties.signatures.items, data: data20 };
                    if (vErrors === null) {
                        vErrors = [err56];
                    }
                    else {
            ...
            const err57 = { instancePath: instancePath + "/signatures", schemaPath: "#/properties/signatures/type", keyword: "type", params: { type: "array" }, message: "must be array", schema: schema51.properties.signatures.type, parentSchema: schema51.properties.signatures, data: data19 };
            if (vErrors === null) {
                vErrors = [err57];
            }
            else {
    ...
    const err58 = { instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" }, message: "must be object", schema: schema51.type, parentSchema: schema51, data };
    if (vErrors === null) {
        vErrors = [err58];
    }
    else {
...
export { validate33 as multiSignatureLegacy };
export { validate34 as multiSignatureLegacyStrict };
export { validate35 as multiSignatureLegacySigned };
