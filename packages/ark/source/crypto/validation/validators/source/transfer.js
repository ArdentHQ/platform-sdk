...
export const transfer = validate43;
const schema60 = {
	$id: "transfer",
...
function validate43(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
	/*# sourceURL="transfer" */ let vErrors = null;
	let errors = 0;
	const _errs1 = errors;
	let valid0 = true;
	const _errs2 = errors;
	...
	if (data && typeof data == "object" && !Array.isArray(data)) {
		...
		if (data.expiration !== undefined) {
			...
			if (!(typeof data15 == "number" && !(data15 % 1) && !isNaN(data15) && isFinite(data15))) {
				const err36 = {
					instancePath: instancePath + "/expiration",
					schemaPath: "#/properties/expiration/type",
					keyword: "type",
					params: { type: "integer" },
					message: "must be integer",
					schema: schema60.properties.expiration.type,
					parentSchema: schema60.properties.expiration,
					data: data15,
				};
				if (vErrors === null) {
					vErrors = [err36];
		...
		if (data.recipientId !== undefined) {
			if (
				!validate37(data.recipientId, {
					instancePath: instancePath + "/recipientId",
					parentData: data,
...
export const transferStrict = validate47;
const schema66 = {
	$id: "transferStrict",
	else: { required: ["type", "senderPublicKey", "fee", "amount", "nonce"] },
	if: { properties: { version: { anyOf: [{ type: "null" }, { const: 1 }] } } },
...
function validate47(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
	/*# sourceURL="transferStrict" */ let vErrors = null;
	let errors = 0;
	const _errs1 = errors;
	let valid0 = false;
	const _errs2 = errors;
		...
		if (data.expiration !== undefined) {
			...
			if (!(typeof data15 == "number" && !(data15 % 1) && !isNaN(data15) && isFinite(data15))) {
				const err45 = {
					...
					params: { type: "integer" },
					message: "must be integer",
					schema: schema66.properties.expiration.type,
					parentSchema: schema66.properties.expiration,
					data: data15,
				};
				if (vErrors === null) {
					vErrors = [err45];
...
export const transferSigned = validate51;
const schema72 = {
	$id: "transferSigned",
	else: { required: ["type", "senderPublicKey", "fee", "amount", "nonce"] },
	if: { properties: { version: { anyOf: [{ type: "null" }, { const: 1 }] } } },
...
function validate51(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
	/*# sourceURL="transferSigned" */ let vErrors = null;
	let errors = 0;
	const _errs1 = errors;
	let valid0 = false;
	const _errs2 = errors;
		...
		if (data.expiration !== undefined) {
			...
			if (!(typeof data15 == "number" && !(data15 % 1) && !isNaN(data15) && isFinite(data15))) {
				const err44 = {
					...
					params: { type: "integer" },
					message: "must be integer",
					schema: schema72.properties.expiration.type,
					parentSchema: schema72.properties.expiration,
					data: data15,
				};
				if (vErrors === null) {
					vErrors = [err44];
