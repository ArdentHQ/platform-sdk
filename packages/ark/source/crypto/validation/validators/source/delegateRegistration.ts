...
const schema47 = { "$id": "delegateRegistration", "else": { "required": ["type", "senderPublicKey", "fee", "amount", "nonce"] }, "if": { "properties": { "version": { "anyOf": [{ "type": "null" }, { "const": 1 }] } } }, "properties": { "amount": { "bignumber": { "minimum": 0, "maximum": 0 } }, "fee": { "bignumber": { "minimum": 1 } }, "id": { "type": "string" }, "network": { "$ref": "networkByte" }, "nonce": { "bignumber": { "minimum": 0 } }, "secondSignature": { "type": "string" }, "senderPublicKey": { "type": "string" }, "signSignature": { "type": "string" }, "signature": { "type": "string" }, "version": { "enum": [1, 2] }, "signatures": { "items": { "type": "string" }, "maxItems": 16, "minItems": 1, "type": "array" }, "timestamp": { "type": "integer", "minimum": 0 }, "typeGroup": { "minimum": 0, "type": "integer" }, "asset": { "properties": { "delegate": { "properties": { "username": { "type": "string" } }, "required": ["username"], "type": "object" } }, "required": ["delegate"], "type": "object" }, "type": { "transactionType": 2 } }, "then": { "required": ["type", "senderPublicKey", "fee", "amount", "timestamp"] }, "type": "object", "required": ["asset"] };
function validate33(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { /*# sourceURL="delegateRegistration" */ ; let vErrors = null; let errors = 0; const _errs1 = errors; let valid0 = true; const _errs2 = errors; if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.asset !== undefined) {
        ...
        if (data15 && typeof data15 == "object" && !Array.isArray(data15)) {
            if (data15.delegate === undefined) {
                const err29 = { instancePath: instancePath + "/asset", schemaPath: "#/properties/asset/required", keyword: "required", params: { missingProperty: "delegate" }, message: "must have required property '" + "delegate" + "'", schema: schema47.properties.asset.required, parentSchema: schema47.properties.asset, data: data15 };
                if (vErrors === null) {
                    vErrors = [err29];
                }
                else {
                ...
                if (data16 && typeof data16 == "object" && !Array.isArray(data16)) {
                    ...
                    if (data16.username !== undefined) {
                        ...
                        if (typeof data17 !== "string") {
                            const err31 = { instancePath: instancePath + "/asset/delegate/username", schemaPath: "#/properties/asset/properties/delegate/properties/username/type", keyword: "type", params: { type: "string" }, message: "must be string", schema: schema47.properties.asset.properties.delegate.properties.username.type, parentSchema: schema47.properties.asset.properties.delegate.properties.username, data: data17 };
                            if (vErrors === null) {
                                vErrors = [err31];
                            }
                            else {
                    ...
                    const err32 = { instancePath: instancePath + "/asset/delegate", schemaPath: "#/properties/asset/properties/delegate/type", keyword: "type", params: { type: "object" }, message: "must be object", schema: schema47.properties.asset.properties.delegate.type, parentSchema: schema47.properties.asset.properties.delegate, data: data16 };
                    if (vErrors === null) {
                        vErrors = [err32];
                    }
                    else {
...
const schema49 = { "$id": "delegateRegistrationStrict", "else": { "required": ["type", "senderPublicKey", "fee", "amount", "nonce"] }, "if": { "properties": { "version": { "anyOf": [{ "type": "null" }, { "const": 1 }] } } }, "properties": { "amount": { "bignumber": { "minimum": 0, "maximum": 0 } }, "fee": { "bignumber": { "minimum": 1 } }, "id": { "type": "string" }, "network": { "$ref": "networkByte" }, "nonce": { "bignumber": { "minimum": 0 } }, "secondSignature": { "type": "string" }, "senderPublicKey": { "type": "string" }, "signSignature": { "type": "string" }, "signature": { "type": "string" }, "version": { "enum": [1, 2] }, "signatures": { "items": { "type": "string" }, "maxItems": 16, "minItems": 1, "type": "array" }, "timestamp": { "type": "integer", "minimum": 0 }, "typeGroup": { "minimum": 0, "type": "integer" }, "asset": { "properties": { "delegate": { "properties": { "username": { "type": "string" } }, "required": ["username"], "type": "object" } }, "required": ["delegate"], "type": "object" }, "type": { "transactionType": 2 } }, "then": { "required": ["type", "senderPublicKey", "fee", "amount", "timestamp"] }, "type": "object", "required": ["asset"], "anyOf": [{ "required": ["id", "signature"] }, { "required": ["id", "signature", "signatures"] }, { "required": ["id", "signatures"] }], "additionalProperties": false };
const func2 = Object.prototype.hasOwnProperty;
function validate34(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { /*# sourceURL="delegateRegistrationStrict" */ ; let vErrors = null; let errors = 0; const _errs1 = errors; let valid0 = false; const _errs2 = errors; if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.id === undefined) {
    ...
    if (data.asset !== undefined) {
        ...
        if (data15 && typeof data15 == "object" && !Array.isArray(data15)) {
            if (data15.delegate === undefined) {
                const err38 = { instancePath: instancePath + "/asset", schemaPath: "#/properties/asset/required", keyword: "required", params: { missingProperty: "delegate" }, message: "must have required property '" + "delegate" + "'", schema: schema49.properties.asset.required, parentSchema: schema49.properties.asset, data: data15 };
                if (vErrors === null) {
                    vErrors = [err38];
                }
                else {
            ...
            if (data15.delegate !== undefined) {
                ...
                if (data16 && typeof data16 == "object" && !Array.isArray(data16)) {
                    if (data16.username === undefined) {
                        const err39 = { instancePath: instancePath + "/asset/delegate", schemaPath: "#/properties/asset/properties/delegate/required", keyword: "required", params: { missingProperty: "username" }, message: "must have required property '" + "username" + "'", schema: schema49.properties.asset.properties.delegate.required, parentSchema: schema49.properties.asset.properties.delegate, data: data16 };
                        if (vErrors === null) {
                            vErrors = [err39];
                        }
                        else {
                    ...
                    const err41 = { instancePath: instancePath + "/asset/delegate", schemaPath: "#/properties/asset/properties/delegate/type", keyword: "type", params: { type: "object" }, message: "must be object", schema: schema49.properties.asset.properties.delegate.type, parentSchema: schema49.properties.asset.properties.delegate, data: data16 };
                    if (vErrors === null) {
                        vErrors = [err41];
                    }
                    else {
...
const schema51 = { "$id": "delegateRegistrationSigned", "else": { "required": ["type", "senderPublicKey", "fee", "amount", "nonce"] }, "if": { "properties": { "version": { "anyOf": [{ "type": "null" }, { "const": 1 }] } } }, "properties": { "amount": { "bignumber": { "minimum": 0, "maximum": 0 } }, "fee": { "bignumber": { "minimum": 1 } }, "id": { "type": "string" }, "network": { "$ref": "networkByte" }, "nonce": { "bignumber": { "minimum": 0 } }, "secondSignature": { "type": "string" }, "senderPublicKey": { "type": "string" }, "signSignature": { "type": "string" }, "signature": { "type": "string" }, "version": { "enum": [1, 2] }, "signatures": { "items": { "type": "string" }, "maxItems": 16, "minItems": 1, "type": "array" }, "timestamp": { "type": "integer", "minimum": 0 }, "typeGroup": { "minimum": 0, "type": "integer" }, "asset": { "properties": { "delegate": { "properties": { "username": { "type": "string" } }, "required": ["username"], "type": "object" } }, "required": ["delegate"], "type": "object" }, "type": { "transactionType": 2 } }, "then": { "required": ["type", "senderPublicKey", "fee", "amount", "timestamp"] }, "type": "object", "required": ["asset"], "anyOf": [{ "required": ["id", "signature"] }, { "required": ["id", "signature", "signatures"] }, { "required": ["id", "signatures"] }] };
function validate35(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { /*# sourceURL="delegateRegistrationSigned" */ ; let vErrors = null; let errors = 0; const _errs1 = errors; let valid0 = false; const _errs2 = errors; if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.id === undefined) {
    ...
    if (data.asset !== undefined) {
        ...
        if (data15 && typeof data15 == "object" && !Array.isArray(data15)) {
            if (data15.delegate === undefined) {
                const err37 = { instancePath: instancePath + "/asset", schemaPath: "#/properties/asset/required", keyword: "required", params: { missingProperty: "delegate" }, message: "must have required property '" + "delegate" + "'", schema: schema51.properties.asset.required, parentSchema: schema51.properties.asset, data: data15 };
                if (vErrors === null) {
                    vErrors = [err37];
                }
                else {
            ...
            if (data15.delegate !== undefined) {
                ...
                if (data16 && typeof data16 == "object" && !Array.isArray(data16)) {
                    if (data16.username === undefined) {
                        const err38 = { instancePath: instancePath + "/asset/delegate", schemaPath: "#/properties/asset/properties/delegate/required", keyword: "required", params: { missingProperty: "username" }, message: "must have required property '" + "username" + "'", schema: schema51.properties.asset.properties.delegate.required, parentSchema: schema51.properties.asset.properties.delegate, data: data16 };
                        if (vErrors === null) {
                            vErrors = [err38];
                        }
                        else {
                    ...
                    const err40 = { instancePath: instancePath + "/asset/delegate", schemaPath: "#/properties/asset/properties/delegate/type", keyword: "type", params: { type: "object" }, message: "must be object", schema: schema51.properties.asset.properties.delegate.type, parentSchema: schema51.properties.asset.properties.delegate, data: data16 };
                    if (vErrors === null) {
                        vErrors = [err40];
                    }
                    else {
...
export { validate33 as delegateRegistration };
export { validate34 as delegateRegistrationStrict };
export { validate35 as delegateRegistrationSigned };
