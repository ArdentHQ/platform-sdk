...
export const delegateResignation = validate43;
const schema60 = {
...
function validate43(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
	/*# sourceURL="delegateResignation" */ let vErrors = null;
	let errors = 0;
	const _errs1 = errors;
	let valid0 = true;
	const _errs2 = errors;
...
export const delegateResignationStrict = validate46;
const schema66 = {
	$id: "delegateResignationStrict",
	else: { required: ["type", "senderPublicKey", "fee", "amount", "nonce"] },
	if: { properties: { version: { anyOf: [{ type: "null" }, { const: 1 }] } } },
	properties: {
		amount: { bignumber: { minimum: 0, maximum: 0 } },
...
function validate46(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
	/*# sourceURL="delegateResignationStrict" */ let vErrors = null;
	let errors = 0;
	const _errs1 = errors;
	let valid0 = false;
	const _errs2 = errors;
...
export const delegateResignationSigned = validate49;
const schema72 = {
...
function validate49(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
	/*# sourceURL="delegateResignationSigned" */ let vErrors = null;
	let errors = 0;
	const _errs1 = errors;
	let valid0 = false;
	const _errs2 = errors;
