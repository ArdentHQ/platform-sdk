...
function validate43(data, _a) {
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
        ...
        var err35 = { instancePath: instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" }, message: "must be object", schema: schema60.type, parentSchema: schema60, data: data };
        if (vErrors === null) {
            vErrors = [err35];
        }
        else {
...
function validate46(data, _a) {
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
        ...
        var err44 = { instancePath: instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" }, message: "must be object", schema: schema66.type, parentSchema: schema66, data: data };
        if (vErrors === null) {
            vErrors = [err44];
        }
        else {
...
function validate49(data, _a) {
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
        ...
        var err43 = { instancePath: instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" }, message: "must be object", schema: schema72.type, parentSchema: schema72, data: data };
        if (vErrors === null) {
            vErrors = [err43];
        }
        else {
