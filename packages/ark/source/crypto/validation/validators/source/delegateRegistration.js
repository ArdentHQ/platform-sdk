...
var validate = (function() {
  ...
  var pattern1 = new RegExp('^[a-z0-9!@$&_.]+$');
  var refVal = [];
  ...
  refVal[5] = refVal5;
  return function validate(data, dataPath, parentData, parentDataProperty, rootData) {
    'use strict'; /*# sourceURL=delegateRegistration */
    var vErrors = null;
    var errors = 0;
    if (rootData === undefined) rootData = data;
        ...
        if ((data1 && typeof data1 === "object" && !Array.isArray(data1))) {
          ...
          if (data2 === undefined) {
            ...
            var err = {
              ...
              params: {
                missingProperty: 'delegate'
              },
              message: 'should have required property \'delegate\''
            };
            if (vErrors === null) vErrors = [err];
            else vErrors.push(err);
            errors++;
            ...
            if ((data2 && typeof data2 === "object" && !Array.isArray(data2))) {
              ...
              if (data3 === undefined) {
                ...
                var err = {
                  keyword: 'required',
                  dataPath: (dataPath || '') + '.asset.delegate',
                ...
                if (typeof data3 === "string") {
                  if (!pattern1.test(data3)) {
                    var err = {
                      keyword: 'pattern',
                      dataPath: (dataPath || '') + '.asset.delegate.username',
