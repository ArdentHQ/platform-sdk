...
export const delegateRegistration = validate43;
const schema60 = {
	...
	properties: {
		...
		asset: {
			properties: {
				delegate: {
					properties: { username: { $ref: "delegateUsername" } },
					required: ["username"],
					type: "object",
				},
			},
...
function validate43(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
	/*# sourceURL="delegateRegistration" */ let vErrors = null;
	let errors = 0;
	const _errs1 = errors;
	let valid0 = true;
	const _errs2 = errors;
			...
			if (data15 && typeof data15 == "object" && !Array.isArray(data15)) {
				if (data15.delegate === undefined) {
					const err36 = {
						...
						keyword: "required",
						params: { missingProperty: "delegate" },
						message: "must have required property '" + "delegate" + "'",
				...
				if (data15.delegate !== undefined) {
					...
					if (data16 && typeof data16 == "object" && !Array.isArray(data16)) {
						if (data16.username === undefined) {
							const err37 = {
								instancePath: instancePath + "/asset/delegate",
								schemaPath: "#/properties/asset/properties/delegate/required",
								keyword: "required",
								params: { missingProperty: "username" },
								message: "must have required property '" + "username" + "'",
								schema: schema60.properties.asset.properties.delegate.required,
								parentSchema: schema60.properties.asset.properties.delegate,
								data: data16,
							};
							if (vErrors === null) {
								vErrors = [err37];
						...
						if (data16.username !== undefined) {
							...
							if (typeof data17 !== "string") {
								const err38 = {
									instancePath: instancePath + "/asset/delegate/username",
									schemaPath: "delegateUsername/type",
									keyword: "type",
									params: { type: "string" },
									message: "must be string",
									schema: schema57.type,
							...
							if (typeof data17 === "string") {
								if (!pattern7.test(data17)) {
									const err39 = {
										instancePath: instancePath + "/asset/delegate/username",
										schemaPath: "delegateUsername/allOf/0/pattern",
										keyword: "pattern",
										params: { pattern: "^[a-z0-9!@$&_.]+$" },
										message: 'must match pattern "' + "^[a-z0-9!@$&_.]+$" + '"',
										schema: "^[a-z0-9!@$&_.]+$",
								...
								const err40 = {
									instancePath: instancePath + "/asset/delegate/username",
									schemaPath: "delegateUsername/allOf/0/type",
									keyword: "type",
									params: { type: "string" },
									message: "must be string",
									schema: schema57.allOf[0].type,
							...
							if (typeof data17 === "string") {
								if (func2(data17) > 20) {
									const err41 = {
										instancePath: instancePath + "/asset/delegate/username",
										schemaPath: "delegateUsername/allOf/1/maxLength",
										keyword: "maxLength",
										params: { limit: 20 },
										message: "must NOT have more than 20 characters",
										schema: 20,
								...
								if (func2(data17) < 1) {
									const err42 = {
										instancePath: instancePath + "/asset/delegate/username",
										schemaPath: "delegateUsername/allOf/1/minLength",
										keyword: "minLength",
										params: { limit: 1 },
										message: "must NOT have fewer than 1 characters",
										schema: 1,
						...
						const err43 = {
							instancePath: instancePath + "/asset/delegate",
							schemaPath: "#/properties/asset/properties/delegate/type",
							keyword: "type",
							params: { type: "object" },
							message: "must be object",
							schema: schema60.properties.asset.properties.delegate.type,
							parentSchema: schema60.properties.asset.properties.delegate,
							data: data16,
						};
						if (vErrors === null) {
...
export const delegateRegistrationStrict = validate46;
const schema67 = {
	$id: "delegateRegistrationStrict",
	else: { required: ["type", "senderPublicKey", "fee", "amount", "nonce"] },
	if: { properties: { version: { anyOf: [{ type: "null" }, { const: 1 }] } } },
	properties: {
		amount: { bignumber: { minimum: 0, maximum: 0 } },
...
function validate46(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
	/*# sourceURL="delegateRegistrationStrict" */ let vErrors = null;
	let errors = 0;
	const _errs1 = errors;
	let valid0 = false;
	const _errs2 = errors;
					...
					if (data16 && typeof data16 == "object" && !Array.isArray(data16)) {
						if (data16.username === undefined) {
							const err46 = {
								...
								params: { missingProperty: "username" },
								message: "must have required property '" + "username" + "'",
								schema: schema67.properties.asset.properties.delegate.required,
								parentSchema: schema67.properties.asset.properties.delegate,
								data: data16,
							};
							if (vErrors === null) {
								vErrors = [err46];
						...
						const err52 = {
							...
							params: { type: "object" },
							message: "must be object",
							schema: schema67.properties.asset.properties.delegate.type,
							parentSchema: schema67.properties.asset.properties.delegate,
							data: data16,
						};
						if (vErrors === null) {
...
export const delegateRegistrationSigned = validate49;
const schema74 = {
...
function validate49(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
	/*# sourceURL="delegateRegistrationSigned" */ let vErrors = null;
	let errors = 0;
	const _errs1 = errors;
	let valid0 = false;
	const _errs2 = errors;
					...
					if (data16 && typeof data16 == "object" && !Array.isArray(data16)) {
						if (data16.username === undefined) {
							const err45 = {
								...
								params: { missingProperty: "username" },
								message: "must have required property '" + "username" + "'",
								schema: schema74.properties.asset.properties.delegate.required,
								parentSchema: schema74.properties.asset.properties.delegate,
								data: data16,
							};
							if (vErrors === null) {
								vErrors = [err45];
						...
						const err51 = {
							...
							params: { type: "object" },
							message: "must be object",
							schema: schema74.properties.asset.properties.delegate.type,
							parentSchema: schema74.properties.asset.properties.delegate,
							data: data16,
						};
						if (vErrors === null) {
