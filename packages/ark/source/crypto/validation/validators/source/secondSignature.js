...
export const secondSignature = validate43;
const schema60 = {
	$id: "secondSignature",
	...
	properties: {
		...
		secondSignature: { $ref: "alphanumeric", type: "null" },
		...
		asset: {
			properties: {
				signature: {
					properties: { publicKey: { $ref: "publicKey" } },
					required: ["publicKey"],
					type: "object",
				},
			},
...
function validate43(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
	/*# sourceURL="secondSignature" */ let vErrors = null;
	let errors = 0;
	const _errs1 = errors;
	let valid0 = true;
	const _errs2 = errors;
		...
		if (data.secondSignature !== undefined) {
			...
			if (data6 !== null) {
				const err17 = {
					...
					schemaPath: "#/properties/secondSignature/type",
					keyword: "type",
					params: { type: "null" },
					message: "must be null",
					schema: schema60.properties.secondSignature.type,
					parentSchema: schema60.properties.secondSignature,
					data: data6,
				};
				if (vErrors === null) {
					vErrors = [err17];
				...
				if (data15.signature !== undefined) {
					...
					if (data16 && typeof data16 == "object" && !Array.isArray(data16)) {
						if (data16.publicKey === undefined) {
							const err38 = {
								instancePath: instancePath + "/asset/signature",
								schemaPath: "#/properties/asset/properties/signature/required",
								keyword: "required",
								params: { missingProperty: "publicKey" },
								message: "must have required property '" + "publicKey" + "'",
								schema: schema60.properties.asset.properties.signature.required,
								parentSchema: schema60.properties.asset.properties.signature,
								data: data16,
							};
							if (vErrors === null) {
								vErrors = [err38];
						...
						if (data16.publicKey !== undefined) {
							if (
								!validate38(data16.publicKey, {
									instancePath: instancePath + "/asset/signature/publicKey",
									parentData: data16,
						...
						const err39 = {
							instancePath: instancePath + "/asset/signature",
							schemaPath: "#/properties/asset/properties/signature/type",
							keyword: "type",
							params: { type: "object" },
							message: "must be object",
							schema: schema60.properties.asset.properties.signature.type,
							parentSchema: schema60.properties.asset.properties.signature,
							data: data16,
						};
						if (vErrors === null) {
...
export const secondSignatureStrict = validate47;
const schema66 = {
	$id: "secondSignatureStrict",
	else: { required: ["type", "senderPublicKey", "fee", "amount", "nonce"] },
	if: { properties: { version: { anyOf: [{ type: "null" }, { const: 1 }] } } },
	properties: {
		amount: { bignumber: { minimum: 0, maximum: 0 } },
...
function validate47(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
	/*# sourceURL="secondSignatureStrict" */ let vErrors = null;
	let errors = 0;
	const _errs1 = errors;
	let valid0 = false;
	const _errs2 = errors;
		...
		if (data.secondSignature !== undefined) {
			...
			if (data6 !== null) {
				const err26 = {
					...
					params: { type: "null" },
					message: "must be null",
					schema: schema66.properties.secondSignature.type,
					parentSchema: schema66.properties.secondSignature,
					data: data6,
				};
				if (vErrors === null) {
					vErrors = [err26];
					...
					if (data16 && typeof data16 == "object" && !Array.isArray(data16)) {
						if (data16.publicKey === undefined) {
							const err47 = {
								...
								params: { missingProperty: "publicKey" },
								message: "must have required property '" + "publicKey" + "'",
								schema: schema66.properties.asset.properties.signature.required,
								parentSchema: schema66.properties.asset.properties.signature,
								data: data16,
							};
							if (vErrors === null) {
								vErrors = [err47];
						...
						const err48 = {
							...
							params: { type: "object" },
							message: "must be object",
							schema: schema66.properties.asset.properties.signature.type,
							parentSchema: schema66.properties.asset.properties.signature,
							data: data16,
						};
						if (vErrors === null) {
...
export const secondSignatureSigned = validate51;
const schema72 = {
	$id: "secondSignatureSigned",
	else: { required: ["type", "senderPublicKey", "fee", "amount", "nonce"] },
	if: { properties: { version: { anyOf: [{ type: "null" }, { const: 1 }] } } },
	properties: {
		amount: { bignumber: { minimum: 0, maximum: 0 } },
...
function validate51(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
	/*# sourceURL="secondSignatureSigned" */ let vErrors = null;
	let errors = 0;
	const _errs1 = errors;
	let valid0 = false;
	const _errs2 = errors;
		...
		if (data.secondSignature !== undefined) {
			...
			if (data6 !== null) {
				const err25 = {
					...
					params: { type: "null" },
					message: "must be null",
					schema: schema72.properties.secondSignature.type,
					parentSchema: schema72.properties.secondSignature,
					data: data6,
				};
				if (vErrors === null) {
					vErrors = [err25];
					...
					if (data16 && typeof data16 == "object" && !Array.isArray(data16)) {
						if (data16.publicKey === undefined) {
							const err46 = {
								...
								params: { missingProperty: "publicKey" },
								message: "must have required property '" + "publicKey" + "'",
								schema: schema72.properties.asset.properties.signature.required,
								parentSchema: schema72.properties.asset.properties.signature,
								data: data16,
							};
							if (vErrors === null) {
								vErrors = [err46];
						...
						const err47 = {
							...
							params: { type: "object" },
							message: "must be object",
							schema: schema72.properties.asset.properties.signature.type,
							parentSchema: schema72.properties.asset.properties.signature,
							data: data16,
						};
						if (vErrors === null) {
