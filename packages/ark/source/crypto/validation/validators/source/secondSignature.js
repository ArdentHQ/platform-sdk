...
var validate = (function() {
  ...
  refVal[4] = refVal4;
  return function validate(data, dataPath, parentData, parentDataProperty, rootData) {
    'use strict'; /*# sourceURL=secondSignature */
    var vErrors = null;
    var errors = 0;
    if (rootData === undefined) rootData = data;
        ...
        if ((data1 && typeof data1 === "object" && !Array.isArray(data1))) {
          ...
          if (data2 === undefined) {
            ...
            if ((data2 && typeof data2 === "object" && !Array.isArray(data2))) {
              var errs__2 = errors;
              var valid3 = true;
              if (data2.publicKey === undefined) {
                valid3 = false;
                var err = {
                  keyword: 'required',
                  dataPath: (dataPath || '') + '.asset.signature',
                  schemaPath: '#/properties/asset/properties/signature/required',
                  params: {
                    missingProperty: 'publicKey'
                  },
                  message: 'should have required property \'publicKey\''
                };
                if (vErrors === null) vErrors = [err];
                else vErrors.push(err);
                errors++;
                ...
                var errs_3 = errors;
                if (!refVal[4](data2.publicKey, (dataPath || '') + '.asset.signature.publicKey', data2, 'publicKey', rootData)) {
