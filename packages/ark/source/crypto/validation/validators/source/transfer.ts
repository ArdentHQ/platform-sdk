...
const schema47 = { "$id": "transfer", "else": { "required": ["type", "senderPublicKey", "fee", "amount", "nonce"] }, "if": { "properties": { "version": { "anyOf": [{ "type": "null" }, { "const": 1 }] } } }, "properties": { "amount": { "bignumber": { "minimum": 1 } }, "fee": { "bignumber": { "minimum": 1 } }, "id": { "type": "string" }, "network": { "$ref": "networkByte" }, "nonce": { "bignumber": { "minimum": 0 } }, "secondSignature": { "type": "string" }, "senderPublicKey": { "type": "string" }, "signSignature": { "type": "string" }, "signature": { "type": "string" }, "version": { "enum": [1, 2] }, "signatures": { "items": { "type": "string" }, "maxItems": 16, "minItems": 1, "type": "array" }, "timestamp": { "type": "integer", "minimum": 0 }, "typeGroup": { "minimum": 0, "type": "integer" }, "expiration": { "minimum": 0, "type": "integer" }, "recipientId": { "type": "string" }, "type": { "transactionType": 0 }, "vendorField": { "anyOf": [{ "type": "null" }, { "type": "string" }] } }, "then": { "required": ["type", "senderPublicKey", "fee", "amount", "timestamp"] }, "type": "object", "required": ["recipientId"] };
function validate33(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { /*# sourceURL="transfer" */ ; let vErrors = null; let errors = 0; const _errs1 = errors; let valid0 = true; const _errs2 = errors; if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.recipientId === undefined) {
        const err14 = { instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: "recipientId" }, message: "must have required property '" + "recipientId" + "'", schema: schema47.required, parentSchema: schema47, data };
        if (vErrors === null) {
            vErrors = [err14];
        }
        else {
    ...
    if (data.expiration !== undefined) {
        ...
        if (!(((typeof data15 == "number") && (!(data15 % 1) && !isNaN(data15))) && (isFinite(data15)))) {
            const err29 = { instancePath: instancePath + "/expiration", schemaPath: "#/properties/expiration/type", keyword: "type", params: { type: "integer" }, message: "must be integer", schema: schema47.properties.expiration.type, parentSchema: schema47.properties.expiration, data: data15 };
            if (vErrors === null) {
                vErrors = [err29];
            }
            else {
        ...
        if ((typeof data15 == "number") && (isFinite(data15))) {
            if (data15 < 0 || isNaN(data15)) {
                const err30 = { instancePath: instancePath + "/expiration", schemaPath: "#/properties/expiration/minimum", keyword: "minimum", params: { comparison: ">=", limit: 0 }, message: "must be >= 0", schema: 0, parentSchema: schema47.properties.expiration, data: data15 };
                if (vErrors === null) {
                    vErrors = [err30];
                }
                else {
    ...
    if (data.recipientId !== undefined) {
        let data16 = data.recipientId;
        if (typeof data16 !== "string") {
            const err31 = { instancePath: instancePath + "/recipientId", schemaPath: "#/properties/recipientId/type", keyword: "type", params: { type: "string" }, message: "must be string", schema: schema47.properties.recipientId.type, parentSchema: schema47.properties.recipientId, data: data16 };
            if (vErrors === null) {
                vErrors = [err31];
            }
            else {
    ...
    if (data.vendorField !== undefined) {
        ...
        if (data18 !== null) {
            const err32 = { instancePath: instancePath + "/vendorField", schemaPath: "#/properties/vendorField/anyOf/0/type", keyword: "type", params: { type: "null" }, message: "must be null", schema: schema47.properties.vendorField.anyOf[0].type, parentSchema: schema47.properties.vendorField.anyOf[0], data: data18 };
            if (vErrors === null) {
                vErrors = [err32];
            }
            else {
        ...
        if (!valid7) {
            ...
            if (typeof data18 !== "string") {
                const err33 = { instancePath: instancePath + "/vendorField", schemaPath: "#/properties/vendorField/anyOf/1/type", keyword: "type", params: { type: "string" }, message: "must be string", schema: schema47.properties.vendorField.anyOf[1].type, parentSchema: schema47.properties.vendorField.anyOf[1], data: data18 };
                if (vErrors === null) {
                    vErrors = [err33];
                }
                else {
        ...
        if (!valid7) {
            const err34 = { instancePath: instancePath + "/vendorField", schemaPath: "#/properties/vendorField/anyOf", keyword: "anyOf", params: {}, message: "must match a schema in anyOf", schema: schema47.properties.vendorField.anyOf, parentSchema: schema47.properties.vendorField, data: data18 };
            if (vErrors === null) {
                vErrors = [err34];
            }
            else {
    ...
    const err35 = { instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" }, message: "must be object", schema: schema47.type, parentSchema: schema47, data };
    if (vErrors === null) {
        vErrors = [err35];
    }
    else {
...
const schema49 = { "$id": "transferStrict", "else": { "required": ["type", "senderPublicKey", "fee", "amount", "nonce"] }, "if": { "properties": { "version": { "anyOf": [{ "type": "null" }, { "const": 1 }] } } }, "properties": { "amount": { "bignumber": { "minimum": 1 } }, "fee": { "bignumber": { "minimum": 1 } }, "id": { "type": "string" }, "network": { "$ref": "networkByte" }, "nonce": { "bignumber": { "minimum": 0 } }, "secondSignature": { "type": "string" }, "senderPublicKey": { "type": "string" }, "signSignature": { "type": "string" }, "signature": { "type": "string" }, "version": { "enum": [1, 2] }, "signatures": { "items": { "type": "string" }, "maxItems": 16, "minItems": 1, "type": "array" }, "timestamp": { "type": "integer", "minimum": 0 }, "typeGroup": { "minimum": 0, "type": "integer" }, "expiration": { "minimum": 0, "type": "integer" }, "recipientId": { "type": "string" }, "type": { "transactionType": 0 }, "vendorField": { "anyOf": [{ "type": "null" }, { "type": "string" }] } }, "then": { "required": ["type", "senderPublicKey", "fee", "amount", "timestamp"] }, "type": "object", "required": ["recipientId"], "anyOf": [{ "required": ["id", "signature"] }, { "required": ["id", "signature", "signatures"] }, { "required": ["id", "signatures"] }], "additionalProperties": false };
const func2 = Object.prototype.hasOwnProperty;
function validate34(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { /*# sourceURL="transferStrict" */ ; let vErrors = null; let errors = 0; const _errs1 = errors; let valid0 = false; const _errs2 = errors; if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.id === undefined) {
    ...
    if (data.recipientId === undefined) {
        const err22 = { instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: "recipientId" }, message: "must have required property '" + "recipientId" + "'", schema: schema49.required, parentSchema: schema49, data };
        if (vErrors === null) {
            vErrors = [err22];
        }
        else {
    ...
    if (data.expiration !== undefined) {
        let data15 = data.expiration;
        if (!(((typeof data15 == "number") && (!(data15 % 1) && !isNaN(data15))) && (isFinite(data15)))) {
            const err38 = { instancePath: instancePath + "/expiration", schemaPath: "#/properties/expiration/type", keyword: "type", params: { type: "integer" }, message: "must be integer", schema: schema49.properties.expiration.type, parentSchema: schema49.properties.expiration, data: data15 };
            if (vErrors === null) {
                vErrors = [err38];
            }
            else {
        ...
        if ((typeof data15 == "number") && (isFinite(data15))) {
            if (data15 < 0 || isNaN(data15)) {
                const err39 = { instancePath: instancePath + "/expiration", schemaPath: "#/properties/expiration/minimum", keyword: "minimum", params: { comparison: ">=", limit: 0 }, message: "must be >= 0", schema: 0, parentSchema: schema49.properties.expiration, data: data15 };
                if (vErrors === null) {
                    vErrors = [err39];
                }
                else {
    ...
    if (data.recipientId !== undefined) {
        let data16 = data.recipientId;
        if (typeof data16 !== "string") {
            const err40 = { instancePath: instancePath + "/recipientId", schemaPath: "#/properties/recipientId/type", keyword: "type", params: { type: "string" }, message: "must be string", schema: schema49.properties.recipientId.type, parentSchema: schema49.properties.recipientId, data: data16 };
            if (vErrors === null) {
                vErrors = [err40];
            }
            else {
    ...
    if (data.vendorField !== undefined) {
        ...
        if (data18 !== null) {
            const err41 = { instancePath: instancePath + "/vendorField", schemaPath: "#/properties/vendorField/anyOf/0/type", keyword: "type", params: { type: "null" }, message: "must be null", schema: schema49.properties.vendorField.anyOf[0].type, parentSchema: schema49.properties.vendorField.anyOf[0], data: data18 };
            if (vErrors === null) {
                vErrors = [err41];
            }
            else {
        ...
        if (!valid8) {
            ...
            if (typeof data18 !== "string") {
                const err42 = { instancePath: instancePath + "/vendorField", schemaPath: "#/properties/vendorField/anyOf/1/type", keyword: "type", params: { type: "string" }, message: "must be string", schema: schema49.properties.vendorField.anyOf[1].type, parentSchema: schema49.properties.vendorField.anyOf[1], data: data18 };
                if (vErrors === null) {
                    vErrors = [err42];
                }
                else {
        ...
        if (!valid8) {
            const err43 = { instancePath: instancePath + "/vendorField", schemaPath: "#/properties/vendorField/anyOf", keyword: "anyOf", params: {}, message: "must match a schema in anyOf", schema: schema49.properties.vendorField.anyOf, parentSchema: schema49.properties.vendorField, data: data18 };
            if (vErrors === null) {
                vErrors = [err43];
            }
            else {
    ...
    const err44 = { instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" }, message: "must be object", schema: schema49.type, parentSchema: schema49, data };
    if (vErrors === null) {
        vErrors = [err44];
    }
    else {
...
const schema51 = { "$id": "transferSigned", "else": { "required": ["type", "senderPublicKey", "fee", "amount", "nonce"] }, "if": { "properties": { "version": { "anyOf": [{ "type": "null" }, { "const": 1 }] } } }, "properties": { "amount": { "bignumber": { "minimum": 1 } }, "fee": { "bignumber": { "minimum": 1 } }, "id": { "type": "string" }, "network": { "$ref": "networkByte" }, "nonce": { "bignumber": { "minimum": 0 } }, "secondSignature": { "type": "string" }, "senderPublicKey": { "type": "string" }, "signSignature": { "type": "string" }, "signature": { "type": "string" }, "version": { "enum": [1, 2] }, "signatures": { "items": { "type": "string" }, "maxItems": 16, "minItems": 1, "type": "array" }, "timestamp": { "type": "integer", "minimum": 0 }, "typeGroup": { "minimum": 0, "type": "integer" }, "expiration": { "minimum": 0, "type": "integer" }, "recipientId": { "type": "string" }, "type": { "transactionType": 0 }, "vendorField": { "anyOf": [{ "type": "null" }, { "type": "string" }] } }, "then": { "required": ["type", "senderPublicKey", "fee", "amount", "timestamp"] }, "type": "object", "required": ["recipientId"], "anyOf": [{ "required": ["id", "signature"] }, { "required": ["id", "signature", "signatures"] }, { "required": ["id", "signatures"] }] };
function validate35(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { /*# sourceURL="transferSigned" */ ; let vErrors = null; let errors = 0; const _errs1 = errors; let valid0 = false; const _errs2 = errors; if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.id === undefined) {
    ...
    if (data.recipientId === undefined) {
        const err22 = { instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: "recipientId" }, message: "must have required property '" + "recipientId" + "'", schema: schema51.required, parentSchema: schema51, data };
        if (vErrors === null) {
            vErrors = [err22];
        }
        else {
    ...
    if (data.expiration !== undefined) {
        let data15 = data.expiration;
        if (!(((typeof data15 == "number") && (!(data15 % 1) && !isNaN(data15))) && (isFinite(data15)))) {
            const err37 = { instancePath: instancePath + "/expiration", schemaPath: "#/properties/expiration/type", keyword: "type", params: { type: "integer" }, message: "must be integer", schema: schema51.properties.expiration.type, parentSchema: schema51.properties.expiration, data: data15 };
            if (vErrors === null) {
                vErrors = [err37];
            }
            else {
        ...
        if ((typeof data15 == "number") && (isFinite(data15))) {
            if (data15 < 0 || isNaN(data15)) {
                const err38 = { instancePath: instancePath + "/expiration", schemaPath: "#/properties/expiration/minimum", keyword: "minimum", params: { comparison: ">=", limit: 0 }, message: "must be >= 0", schema: 0, parentSchema: schema51.properties.expiration, data: data15 };
                if (vErrors === null) {
                    vErrors = [err38];
                }
                else {
    ...
    if (data.recipientId !== undefined) {
        let data16 = data.recipientId;
        if (typeof data16 !== "string") {
            const err39 = { instancePath: instancePath + "/recipientId", schemaPath: "#/properties/recipientId/type", keyword: "type", params: { type: "string" }, message: "must be string", schema: schema51.properties.recipientId.type, parentSchema: schema51.properties.recipientId, data: data16 };
            if (vErrors === null) {
                vErrors = [err39];
            }
            else {
    ...
    if (data.vendorField !== undefined) {
        ...
        const _errs45 = errors;
        if (data18 !== null) {
            const err40 = { instancePath: instancePath + "/vendorField", schemaPath: "#/properties/vendorField/anyOf/0/type", keyword: "type", params: { type: "null" }, message: "must be null", schema: schema51.properties.vendorField.anyOf[0].type, parentSchema: schema51.properties.vendorField.anyOf[0], data: data18 };
            if (vErrors === null) {
                vErrors = [err40];
            }
            else {
        ...
        if (!valid8) {
            ...
            if (typeof data18 !== "string") {
                const err41 = { instancePath: instancePath + "/vendorField", schemaPath: "#/properties/vendorField/anyOf/1/type", keyword: "type", params: { type: "string" }, message: "must be string", schema: schema51.properties.vendorField.anyOf[1].type, parentSchema: schema51.properties.vendorField.anyOf[1], data: data18 };
                if (vErrors === null) {
                    vErrors = [err41];
                }
                else {
        ...
        if (!valid8) {
            const err42 = { instancePath: instancePath + "/vendorField", schemaPath: "#/properties/vendorField/anyOf", keyword: "anyOf", params: {}, message: "must match a schema in anyOf", schema: schema51.properties.vendorField.anyOf, parentSchema: schema51.properties.vendorField, data: data18 };
            if (vErrors === null) {
                vErrors = [err42];
            }
            else {
    ...
    const err43 = { instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" }, message: "must be object", schema: schema51.type, parentSchema: schema51, data };
    if (vErrors === null) {
        vErrors = [err43];
    }
    else {
...
export { validate33 as transfer };
export { validate34 as transferStrict };
export { validate35 as transferSigned };
