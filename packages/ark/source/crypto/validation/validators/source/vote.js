...
const schema60 = {
	...
	properties: {
		...
		asset: {
			properties: { votes: { items: { $ref: "walletVote" }, minItems: 1, maxItems: 2, type: "array" } },
			required: ["votes"],
			type: "object",
		},
...
function validate43(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
	/*# sourceURL="vote" */ let vErrors = null;
	let errors = 0;
	const _errs1 = errors;
	let valid0 = true;
	const _errs2 = errors;
			...
			if (data15 && typeof data15 == "object" && !Array.isArray(data15)) {
				if (data15.votes === undefined) {
					const err36 = {
						...
						keyword: "required",
						params: { missingProperty: "votes" },
						message: "must have required property '" + "votes" + "'",
				...
				if (data15.votes !== undefined) {
					...
					if (Array.isArray(data16)) {
						if (data16.length > 2) {
							const err37 = {
								instancePath: instancePath + "/asset/votes",
								schemaPath: "#/properties/asset/properties/votes/maxItems",
								keyword: "maxItems",
								params: { limit: 2 },
								message: "must NOT have more than 2 items",
								schema: 2,
								parentSchema: schema60.properties.asset.properties.votes,
								data: data16,
							};
							if (vErrors === null) {
								vErrors = [err37];
						...
						if (data16.length < 1) {
							const err38 = {
								instancePath: instancePath + "/asset/votes",
								schemaPath: "#/properties/asset/properties/votes/minItems",
								keyword: "minItems",
								params: { limit: 1 },
								message: "must NOT have fewer than 1 items",
								schema: 1,
						...
						for (let i2 = 0; i2 < len1; i2++) {
							...
							if (typeof data17 === "string") {
								if (!pattern6.test(data17)) {
									const err39 = {
										instancePath: instancePath + "/asset/votes/" + i2,
										schemaPath: "walletVote/allOf/0/pattern",
										keyword: "pattern",
										params: { pattern: "^[+|-][a-zA-Z0-9]{66}$" },
										message: 'must match pattern "' + "^[+|-][a-zA-Z0-9]{66}$" + '"',
										schema: "^[+|-][a-zA-Z0-9]{66}$",
								...
								const err40 = {
									instancePath: instancePath + "/asset/votes/" + i2,
									schemaPath: "walletVote/allOf/0/type",
									keyword: "type",
									params: { type: "string" },
									message: "must be string",
									schema: schema56.allOf[0].type,
						...
						const err41 = {
							instancePath: instancePath + "/asset/votes",
							schemaPath: "#/properties/asset/properties/votes/type",
							keyword: "type",
							params: { type: "array" },
							message: "must be array",
							schema: schema60.properties.asset.properties.votes.type,
							parentSchema: schema60.properties.asset.properties.votes,
							data: data16,
						};
						if (vErrors === null) {
...
export const voteStrict = validate47;
const schema67 = {
	$id: "voteStrict",
	else: { required: ["type", "senderPublicKey", "fee", "amount", "nonce"] },
	if: { properties: { version: { anyOf: [{ type: "null" }, { const: 1 }] } } },
...
function validate47(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
	/*# sourceURL="voteStrict" */ let vErrors = null;
	let errors = 0;
	const _errs1 = errors;
	let valid0 = false;
	const _errs2 = errors;
					...
					if (Array.isArray(data16)) {
						if (data16.length > 2) {
							const err46 = {
								...
								message: "must NOT have more than 2 items",
								schema: 2,
								parentSchema: schema67.properties.asset.properties.votes,
								data: data16,
							};
							if (vErrors === null) {
								vErrors = [err46];
						...
						const err50 = {
							...
							params: { type: "array" },
							message: "must be array",
							schema: schema67.properties.asset.properties.votes.type,
							parentSchema: schema67.properties.asset.properties.votes,
							data: data16,
						};
						if (vErrors === null) {
...
export const voteSigned = validate51;
const schema74 = {
	$id: "voteSigned",
	else: { required: ["type", "senderPublicKey", "fee", "amount", "nonce"] },
	if: { properties: { version: { anyOf: [{ type: "null" }, { const: 1 }] } } },
...
function validate51(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
	/*# sourceURL="voteSigned" */ let vErrors = null;
	let errors = 0;
	const _errs1 = errors;
	let valid0 = false;
	const _errs2 = errors;
					...
					if (Array.isArray(data16)) {
						if (data16.length > 2) {
							const err45 = {
								...
								message: "must NOT have more than 2 items",
								schema: 2,
								parentSchema: schema74.properties.asset.properties.votes,
								data: data16,
							};
							if (vErrors === null) {
								vErrors = [err45];
						...
						const err49 = {
							...
							params: { type: "array" },
							message: "must be array",
							schema: schema74.properties.asset.properties.votes.type,
							parentSchema: schema74.properties.asset.properties.votes,
							data: data16,
						};
						if (vErrors === null) {
