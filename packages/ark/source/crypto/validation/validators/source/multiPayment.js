...
var validate = (function() {
  ...
  refVal[5] = refVal5;
  return function validate(data, dataPath, parentData, parentDataProperty, rootData) {
    'use strict'; /*# sourceURL=multiPayment */
    var vErrors = null;
    var errors = 0;
    if (rootData === undefined) rootData = data;
        ...
        if ((data1 && typeof data1 === "object" && !Array.isArray(data1))) {
          ...
          if (data2 === undefined) {
            ...
            var err = {
              ...
              params: {
                missingProperty: 'payments'
              },
              message: 'should have required property \'payments\''
            };
            if (vErrors === null) vErrors = [err];
            else vErrors.push(err);
            errors++;
            ...
            if (Array.isArray(data2)) {
              if (data2.length < 2) {
                var err = {
                  keyword: 'minItems',
                  dataPath: (dataPath || '') + '.asset.payments',
              ...
              for (var i2 = 0; i2 < data2.length; i2++) {
                ...
                if ((data3 && typeof data3 === "object" && !Array.isArray(data3))) {
                  if (data3.amount === undefined) {
                    var err = {
                      keyword: 'required',
                      dataPath: (dataPath || '') + '.asset.payments[' + i2 + ']',
                  ...
                  var errs__3 = errors;
                  var valid4 = true;
                  if (data3.recipientId === undefined) {
                    valid4 = false;
                    var err = {
                      keyword: 'required',
                      dataPath: (dataPath || '') + '.asset.payments[' + i2 + ']',
                    ...
                    var errs_4 = errors;
                    if (!refVal5(data3.recipientId, (dataPath || '') + '.asset.payments[' + i2 + '].recipientId', data3, 'recipientId', rootData)) {
