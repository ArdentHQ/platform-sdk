...
function validate43(data, _a) {
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
        ...
        if (data.asset !== undefined) {
            ...
            if (data15 && typeof data15 == "object" && !Array.isArray(data15)) {
                if (data15.payments === undefined) {
                    var err35 = { instancePath: instancePath + "/asset", schemaPath: "#/properties/asset/required", keyword: "required", params: { missingProperty: "payments" }, message: "must have required property '" + "payments" + "'", schema: schema60.properties.asset.required, parentSchema: schema60.properties.asset, data: data15 };
                    if (vErrors === null) {
                        vErrors = [err35];
                    }
                    else {
                ...
                if (data15.payments !== undefined) {
                    var data16 = data15.payments;
                    if (Array.isArray(data16)) {
                        if (data16.length < 2) {
                            var err36 = { instancePath: instancePath + "/asset/payments", schemaPath: "#/properties/asset/properties/payments/minItems", keyword: "minItems", params: { limit: 2 }, message: "must NOT have fewer than 2 items", schema: 2, parentSchema: schema60.properties.asset.properties.payments, data: data16 };
                            if (vErrors === null) {
                                vErrors = [err36];
                            }
                            else {
                        ...
                        for (var i2 = 0; i2 < len1; i2++) {
                            ...
                            if (data17 && typeof data17 == "object" && !Array.isArray(data17)) {
                                ...
                                if (data17.recipientId !== undefined) {
                                    if (!(validate37(data17.recipientId, { instancePath: instancePath + "/asset/payments/" + i2 + "/recipientId", parentData: data17, parentDataProperty: "recipientId", rootData: rootData }))) {
                        ...
                        var err40 = { instancePath: instancePath + "/asset/payments", schemaPath: "#/properties/asset/properties/payments/type", keyword: "type", params: { type: "array" }, message: "must be array", schema: schema60.properties.asset.properties.payments.type, parentSchema: schema60.properties.asset.properties.payments, data: data16 };
                        if (vErrors === null) {
                            vErrors = [err40];
                        }
                        else {
                ...
                var err41 = { instancePath: instancePath + "/asset", schemaPath: "#/properties/asset/type", keyword: "type", params: { type: "object" }, message: "must be object", schema: schema60.properties.asset.type, parentSchema: schema60.properties.asset, data: data15 };
                if (vErrors === null) {
                    vErrors = [err41];
                }
                else {
        ...
        if (data.vendorField !== undefined) {
            var data21 = data.vendorField;
            var _errs52 = errors;
            var valid18 = false;
            var _errs53 = errors;
            if (data21 !== null) {
                var err42 = { instancePath: instancePath + "/vendorField", schemaPath: "#/properties/vendorField/anyOf/0/type", keyword: "type", params: { type: "null" }, message: "must be null", schema: schema60.properties.vendorField.anyOf[0].type, parentSchema: schema60.properties.vendorField.anyOf[0], data: data21 };
                if (vErrors === null) {
                    vErrors = [err42];
                }
                else {
            ...
            if (!valid18) {
                ...
                if (typeof data21 !== "string") {
                    var err43 = { instancePath: instancePath + "/vendorField", schemaPath: "#/properties/vendorField/anyOf/1/type", keyword: "type", params: { type: "string" }, message: "must be string", schema: schema60.properties.vendorField.anyOf[1].type, parentSchema: schema60.properties.vendorField.anyOf[1], data: data21 };
                    if (vErrors === null) {
                        vErrors = [err43];
                    }
                    else {
            ...
            if (!valid18) {
                var err44 = { instancePath: instancePath + "/vendorField", schemaPath: "#/properties/vendorField/anyOf", keyword: "anyOf", params: {}, message: "must match a schema in anyOf", schema: schema60.properties.vendorField.anyOf, parentSchema: schema60.properties.vendorField, data: data21 };
                if (vErrors === null) {
                    vErrors = [err44];
                }
                else {
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
        for (var key0 in data) {
            if (!(func20.call(schema66.properties, key0))) {
                var err22 = { instancePath: instancePath, schemaPath: "#/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key0 }, message: "must NOT have additional properties", schema: false, parentSchema: schema66, data: data };
                if (vErrors === null) {
                    vErrors = [err22];
                }
                else {
        ...
        if (data.id !== undefined) {
            ...
            if (!valid5) {
                var _errs20 = errors;
                if (data3 !== null) {
                    var err23 = { instancePath: instancePath + "/id", schemaPath: "#/properties/id/anyOf/1/type", keyword: "type", params: { type: "null" }, message: "must be null", schema: schema66.properties.id.anyOf[1].type, parentSchema: schema66.properties.id.anyOf[1], data: data3 };
                    if (vErrors === null) {
                        vErrors = [err23];
                    }
                    else {
            ...
            if (!valid5) {
                var err24 = { instancePath: instancePath + "/id", schemaPath: "#/properties/id/anyOf", keyword: "anyOf", params: {}, message: "must match a schema in anyOf", schema: schema66.properties.id.anyOf, parentSchema: schema66.properties.id, data: data3 };
                if (vErrors === null) {
                    vErrors = [err24];
                }
                else {
        ...
        if (data.version !== undefined) {
            var data10 = data.version;
            if (!((data10 === 1) || (data10 === 2))) {
                var err31 = { instancePath: instancePath + "/version", schemaPath: "#/properties/version/enum", keyword: "enum", params: { allowedValues: schema66.properties.version.enum }, message: "must be equal to one of the allowed values", schema: schema66.properties.version.enum, parentSchema: schema66.properties.version, data: data10 };
                if (vErrors === null) {
                    vErrors = [err31];
                }
                else {
        ...
        if (data.signatures !== undefined) {
            ...
            if (Array.isArray(data11)) {
                if (data11.length > 16) {
                    var err32 = { instancePath: instancePath + "/signatures", schemaPath: "#/properties/signatures/maxItems", keyword: "maxItems", params: { limit: 16 }, message: "must NOT have more than 16 items", schema: 16, parentSchema: schema66.properties.signatures, data: data11 };
                    if (vErrors === null) {
                        vErrors = [err32];
                    }
                    else {
                ...
                if (data11.length < 1) {
                    var err33 = { instancePath: instancePath + "/signatures", schemaPath: "#/properties/signatures/minItems", keyword: "minItems", params: { limit: 1 }, message: "must NOT have fewer than 1 items", schema: 1, parentSchema: schema66.properties.signatures, data: data11 };
                    if (vErrors === null) {
                        vErrors = [err33];
                    }
                    else {
                ...
                for (var i0 = 0; i0 < len0; i0++) {
                    ...
                    if (typeof data12 === "string") {
                        if (func2(data12) > 130) {
                            var err34 = { instancePath: instancePath + "/signatures/" + i0, schemaPath: "#/properties/signatures/items/allOf/0/maxLength", keyword: "maxLength", params: { limit: 130 }, message: "must NOT have more than 130 characters", schema: 130, parentSchema: schema66.properties.signatures.items.allOf[0], data: data12 };
                            if (vErrors === null) {
                                vErrors = [err34];
                            }
                            else {
                        ...
                        if (func2(data12) < 130) {
                            var err35 = { instancePath: instancePath + "/signatures/" + i0, schemaPath: "#/properties/signatures/items/allOf/0/minLength", keyword: "minLength", params: { limit: 130 }, message: "must NOT have fewer than 130 characters", schema: 130, parentSchema: schema66.properties.signatures.items.allOf[0], data: data12 };
                            if (vErrors === null) {
                                vErrors = [err35];
                            }
                            else {
                ...
                if (i1 > 1) {
                    outer0: for (; i1--;) {
                        for (j0 = i1; j0--;) {
                            if (func0(data11[i1], data11[j0])) {
                                var err38 = { instancePath: instancePath + "/signatures", schemaPath: "#/properties/signatures/uniqueItems", keyword: "uniqueItems", params: { i: i1, j: j0 }, message: "must NOT have duplicate items (items ## " + j0 + " and " + i1 + " are identical)", schema: true, parentSchema: schema66.properties.signatures, data: data11 };
                                if (vErrors === null) {
                                    vErrors = [err38];
                                }
                                else {
                ...
                var err39 = { instancePath: instancePath + "/signatures", schemaPath: "#/properties/signatures/type", keyword: "type", params: { type: "array" }, message: "must be array", schema: schema66.properties.signatures.type, parentSchema: schema66.properties.signatures, data: data11 };
                if (vErrors === null) {
                    vErrors = [err39];
                }
                else {
        ...
        if (data.timestamp !== undefined) {
            var data13 = data.timestamp;
            if (!(((typeof data13 == "number") && (!(data13 % 1) && !isNaN(data13))) && (isFinite(data13)))) {
                var err40 = { instancePath: instancePath + "/timestamp", schemaPath: "#/properties/timestamp/type", keyword: "type", params: { type: "integer" }, message: "must be integer", schema: schema66.properties.timestamp.type, parentSchema: schema66.properties.timestamp, data: data13 };
                if (vErrors === null) {
                    vErrors = [err40];
                }
                else {
            ...
            if ((typeof data13 == "number") && (isFinite(data13))) {
                if (data13 < 0 || isNaN(data13)) {
                    var err41 = { instancePath: instancePath + "/timestamp", schemaPath: "#/properties/timestamp/minimum", keyword: "minimum", params: { comparison: ">=", limit: 0 }, message: "must be >= 0", schema: 0, parentSchema: schema66.properties.timestamp, data: data13 };
                    if (vErrors === null) {
                        vErrors = [err41];
                    }
                    else {
        ...
        if (data.typeGroup !== undefined) {
            var data14 = data.typeGroup;
            if (!(((typeof data14 == "number") && (!(data14 % 1) && !isNaN(data14))) && (isFinite(data14)))) {
                var err42 = { instancePath: instancePath + "/typeGroup", schemaPath: "#/properties/typeGroup/type", keyword: "type", params: { type: "integer" }, message: "must be integer", schema: schema66.properties.typeGroup.type, parentSchema: schema66.properties.typeGroup, data: data14 };
                if (vErrors === null) {
                    vErrors = [err42];
                }
                else {
            ...
            if ((typeof data14 == "number") && (isFinite(data14))) {
                if (data14 < 0 || isNaN(data14)) {
                    var err43 = { instancePath: instancePath + "/typeGroup", schemaPath: "#/properties/typeGroup/minimum", keyword: "minimum", params: { comparison: ">=", limit: 0 }, message: "must be >= 0", schema: 0, parentSchema: schema66.properties.typeGroup, data: data14 };
                    if (vErrors === null) {
                        vErrors = [err43];
                    }
                    else {
        ...
        if (data.asset !== undefined) {
            ...
            if (data15 && typeof data15 == "object" && !Array.isArray(data15)) {
                if (data15.payments === undefined) {
                    var err44 = { instancePath: instancePath + "/asset", schemaPath: "#/properties/asset/required", keyword: "required", params: { missingProperty: "payments" }, message: "must have required property '" + "payments" + "'", schema: schema66.properties.asset.required, parentSchema: schema66.properties.asset, data: data15 };
                    if (vErrors === null) {
                        vErrors = [err44];
                    }
                    else {
                ...
                if (data15.payments !== undefined) {
                    ...
                    if (Array.isArray(data16)) {
                        if (data16.length < 2) {
                            var err45 = { instancePath: instancePath + "/asset/payments", schemaPath: "#/properties/asset/properties/payments/minItems", keyword: "minItems", params: { limit: 2 }, message: "must NOT have fewer than 2 items", schema: 2, parentSchema: schema66.properties.asset.properties.payments, data: data16 };
                            if (vErrors === null) {
                                vErrors = [err45];
                            }
                            else {
                        ...
                        var err49 = { instancePath: instancePath + "/asset/payments", schemaPath: "#/properties/asset/properties/payments/type", keyword: "type", params: { type: "array" }, message: "must be array", schema: schema66.properties.asset.properties.payments.type, parentSchema: schema66.properties.asset.properties.payments, data: data16 };
                        if (vErrors === null) {
                            vErrors = [err49];
                        }
                        else {
                ...
                var err50 = { instancePath: instancePath + "/asset", schemaPath: "#/properties/asset/type", keyword: "type", params: { type: "object" }, message: "must be object", schema: schema66.properties.asset.type, parentSchema: schema66.properties.asset, data: data15 };
                if (vErrors === null) {
                    vErrors = [err50];
                }
                else {
        ...
        if (data.vendorField !== undefined) {
            ...
            var _errs58 = errors;
            if (data21 !== null) {
                var err51 = { instancePath: instancePath + "/vendorField", schemaPath: "#/properties/vendorField/anyOf/0/type", keyword: "type", params: { type: "null" }, message: "must be null", schema: schema66.properties.vendorField.anyOf[0].type, parentSchema: schema66.properties.vendorField.anyOf[0], data: data21 };
                if (vErrors === null) {
                    vErrors = [err51];
                }
                else {
            ...
            if (!valid19) {
                var _errs60 = errors;
                if (typeof data21 !== "string") {
                    var err52 = { instancePath: instancePath + "/vendorField", schemaPath: "#/properties/vendorField/anyOf/1/type", keyword: "type", params: { type: "string" }, message: "must be string", schema: schema66.properties.vendorField.anyOf[1].type, parentSchema: schema66.properties.vendorField.anyOf[1], data: data21 };
                    if (vErrors === null) {
                        vErrors = [err52];
                    }
                    else {
            ...
            if (!valid19) {
                var err53 = { instancePath: instancePath + "/vendorField", schemaPath: "#/properties/vendorField/anyOf", keyword: "anyOf", params: {}, message: "must match a schema in anyOf", schema: schema66.properties.vendorField.anyOf, parentSchema: schema66.properties.vendorField, data: data21 };
                if (vErrors === null) {
                    vErrors = [err53];
                }
                else {
        ...
        var err54 = { instancePath: instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" }, message: "must be object", schema: schema66.type, parentSchema: schema66, data: data };
        if (vErrors === null) {
            vErrors = [err54];
        }
        else {
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
        if (data.id !== undefined) {
            ...
            if (!valid5) {
                var _errs19 = errors;
                if (data3 !== null) {
                    var err22 = { instancePath: instancePath + "/id", schemaPath: "#/properties/id/anyOf/1/type", keyword: "type", params: { type: "null" }, message: "must be null", schema: schema72.properties.id.anyOf[1].type, parentSchema: schema72.properties.id.anyOf[1], data: data3 };
                    if (vErrors === null) {
                        vErrors = [err22];
                    }
                    else {
            ...
            if (!valid5) {
                var err23 = { instancePath: instancePath + "/id", schemaPath: "#/properties/id/anyOf", keyword: "anyOf", params: {}, message: "must match a schema in anyOf", schema: schema72.properties.id.anyOf, parentSchema: schema72.properties.id, data: data3 };
                if (vErrors === null) {
                    vErrors = [err23];
                }
                else {
        ...
        if (data.version !== undefined) {
            var data10 = data.version;
            if (!((data10 === 1) || (data10 === 2))) {
                var err30 = { instancePath: instancePath + "/version", schemaPath: "#/properties/version/enum", keyword: "enum", params: { allowedValues: schema72.properties.version.enum }, message: "must be equal to one of the allowed values", schema: schema72.properties.version.enum, parentSchema: schema72.properties.version, data: data10 };
                if (vErrors === null) {
                    vErrors = [err30];
                }
                else {
        ...
        if (data.signatures !== undefined) {
            ...
            if (Array.isArray(data11)) {
                if (data11.length > 16) {
                    var err31 = { instancePath: instancePath + "/signatures", schemaPath: "#/properties/signatures/maxItems", keyword: "maxItems", params: { limit: 16 }, message: "must NOT have more than 16 items", schema: 16, parentSchema: schema72.properties.signatures, data: data11 };
                    if (vErrors === null) {
                        vErrors = [err31];
                    }
                    else {
                ...
                if (data11.length < 1) {
                    var err32 = { instancePath: instancePath + "/signatures", schemaPath: "#/properties/signatures/minItems", keyword: "minItems", params: { limit: 1 }, message: "must NOT have fewer than 1 items", schema: 1, parentSchema: schema72.properties.signatures, data: data11 };
                    if (vErrors === null) {
                        vErrors = [err32];
                    }
                    else {
                ...
                for (var i0 = 0; i0 < len0; i0++) {
                    ...
                    if (typeof data12 === "string") {
                        if (func2(data12) > 130) {
                            var err33 = { instancePath: instancePath + "/signatures/" + i0, schemaPath: "#/properties/signatures/items/allOf/0/maxLength", keyword: "maxLength", params: { limit: 130 }, message: "must NOT have more than 130 characters", schema: 130, parentSchema: schema72.properties.signatures.items.allOf[0], data: data12 };
                            if (vErrors === null) {
                                vErrors = [err33];
                            }
                            else {
                        ...
                        if (func2(data12) < 130) {
                            var err34 = { instancePath: instancePath + "/signatures/" + i0, schemaPath: "#/properties/signatures/items/allOf/0/minLength", keyword: "minLength", params: { limit: 130 }, message: "must NOT have fewer than 130 characters", schema: 130, parentSchema: schema72.properties.signatures.items.allOf[0], data: data12 };
                            if (vErrors === null) {
                                vErrors = [err34];
                            }
                            else {
                ...
                if (i1 > 1) {
                    outer0: for (; i1--;) {
                        for (j0 = i1; j0--;) {
                            if (func0(data11[i1], data11[j0])) {
                                var err37 = { instancePath: instancePath + "/signatures", schemaPath: "#/properties/signatures/uniqueItems", keyword: "uniqueItems", params: { i: i1, j: j0 }, message: "must NOT have duplicate items (items ## " + j0 + " and " + i1 + " are identical)", schema: true, parentSchema: schema72.properties.signatures, data: data11 };
                                if (vErrors === null) {
                                    vErrors = [err37];
                                }
                                else {
                ...
                var err38 = { instancePath: instancePath + "/signatures", schemaPath: "#/properties/signatures/type", keyword: "type", params: { type: "array" }, message: "must be array", schema: schema72.properties.signatures.type, parentSchema: schema72.properties.signatures, data: data11 };
                if (vErrors === null) {
                    vErrors = [err38];
                }
                else {
        ...
        if (data.timestamp !== undefined) {
            var data13 = data.timestamp;
            if (!(((typeof data13 == "number") && (!(data13 % 1) && !isNaN(data13))) && (isFinite(data13)))) {
                var err39 = { instancePath: instancePath + "/timestamp", schemaPath: "#/properties/timestamp/type", keyword: "type", params: { type: "integer" }, message: "must be integer", schema: schema72.properties.timestamp.type, parentSchema: schema72.properties.timestamp, data: data13 };
                if (vErrors === null) {
                    vErrors = [err39];
                }
                else {
            ...
            if ((typeof data13 == "number") && (isFinite(data13))) {
                if (data13 < 0 || isNaN(data13)) {
                    var err40 = { instancePath: instancePath + "/timestamp", schemaPath: "#/properties/timestamp/minimum", keyword: "minimum", params: { comparison: ">=", limit: 0 }, message: "must be >= 0", schema: 0, parentSchema: schema72.properties.timestamp, data: data13 };
                    if (vErrors === null) {
                        vErrors = [err40];
                    }
                    else {
        ...
        if (data.typeGroup !== undefined) {
            var data14 = data.typeGroup;
            if (!(((typeof data14 == "number") && (!(data14 % 1) && !isNaN(data14))) && (isFinite(data14)))) {
                var err41 = { instancePath: instancePath + "/typeGroup", schemaPath: "#/properties/typeGroup/type", keyword: "type", params: { type: "integer" }, message: "must be integer", schema: schema72.properties.typeGroup.type, parentSchema: schema72.properties.typeGroup, data: data14 };
                if (vErrors === null) {
                    vErrors = [err41];
                }
                else {
            ...
            if ((typeof data14 == "number") && (isFinite(data14))) {
                if (data14 < 0 || isNaN(data14)) {
                    var err42 = { instancePath: instancePath + "/typeGroup", schemaPath: "#/properties/typeGroup/minimum", keyword: "minimum", params: { comparison: ">=", limit: 0 }, message: "must be >= 0", schema: 0, parentSchema: schema72.properties.typeGroup, data: data14 };
                    if (vErrors === null) {
                        vErrors = [err42];
                    }
                    else {
        ...
        if (data.asset !== undefined) {
            ...
            if (data15 && typeof data15 == "object" && !Array.isArray(data15)) {
                if (data15.payments === undefined) {
                    var err43 = { instancePath: instancePath + "/asset", schemaPath: "#/properties/asset/required", keyword: "required", params: { missingProperty: "payments" }, message: "must have required property '" + "payments" + "'", schema: schema72.properties.asset.required, parentSchema: schema72.properties.asset, data: data15 };
                    if (vErrors === null) {
                        vErrors = [err43];
                    }
                    else {
                ...
                if (data15.payments !== undefined) {
                    ...
                    if (Array.isArray(data16)) {
                        if (data16.length < 2) {
                            var err44 = { instancePath: instancePath + "/asset/payments", schemaPath: "#/properties/asset/properties/payments/minItems", keyword: "minItems", params: { limit: 2 }, message: "must NOT have fewer than 2 items", schema: 2, parentSchema: schema72.properties.asset.properties.payments, data: data16 };
                            if (vErrors === null) {
                                vErrors = [err44];
                            }
                            else {
                        ...
                        var err48 = { instancePath: instancePath + "/asset/payments", schemaPath: "#/properties/asset/properties/payments/type", keyword: "type", params: { type: "array" }, message: "must be array", schema: schema72.properties.asset.properties.payments.type, parentSchema: schema72.properties.asset.properties.payments, data: data16 };
                        if (vErrors === null) {
                            vErrors = [err48];
                        }
                        else {
                ...
                var err49 = { instancePath: instancePath + "/asset", schemaPath: "#/properties/asset/type", keyword: "type", params: { type: "object" }, message: "must be object", schema: schema72.properties.asset.type, parentSchema: schema72.properties.asset, data: data15 };
                if (vErrors === null) {
                    vErrors = [err49];
                }
                else {
        ...
        if (data.vendorField !== undefined) {
            ...
            var _errs57 = errors;
            if (data21 !== null) {
                var err50 = { instancePath: instancePath + "/vendorField", schemaPath: "#/properties/vendorField/anyOf/0/type", keyword: "type", params: { type: "null" }, message: "must be null", schema: schema72.properties.vendorField.anyOf[0].type, parentSchema: schema72.properties.vendorField.anyOf[0], data: data21 };
                if (vErrors === null) {
                    vErrors = [err50];
                }
                else {
            ...
            if (!valid19) {
                var _errs59 = errors;
                if (typeof data21 !== "string") {
                    var err51 = { instancePath: instancePath + "/vendorField", schemaPath: "#/properties/vendorField/anyOf/1/type", keyword: "type", params: { type: "string" }, message: "must be string", schema: schema72.properties.vendorField.anyOf[1].type, parentSchema: schema72.properties.vendorField.anyOf[1], data: data21 };
                    if (vErrors === null) {
                        vErrors = [err51];
                    }
                    else {
            ...
            if (!valid19) {
                var err52 = { instancePath: instancePath + "/vendorField", schemaPath: "#/properties/vendorField/anyOf", keyword: "anyOf", params: {}, message: "must match a schema in anyOf", schema: schema72.properties.vendorField.anyOf, parentSchema: schema72.properties.vendorField, data: data21 };
                if (vErrors === null) {
                    vErrors = [err52];
                }
                else {
        ...
        var err53 = { instancePath: instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" }, message: "must be object", schema: schema72.type, parentSchema: schema72, data: data };
        if (vErrors === null) {
            vErrors = [err53];
        }
        else {
