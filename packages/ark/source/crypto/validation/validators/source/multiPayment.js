...
export const multiPayment = validate43;
const schema60 = {
	$id: "multiPayment",
			...
			properties: {
				payments: {
					items: {
						...
						properties: { amount: { bignumber: { minimum: 1 } }, recipientId: { $ref: "address" } },
						type: "object",
					},
					minItems: 2,
					type: "array",
...
function validate43(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
	/*# sourceURL="multiPayment" */ let vErrors = null;
	let errors = 0;
	const _errs1 = errors;
	let valid0 = true;
	const _errs2 = errors;
	...
	if (data && typeof data == "object" && !Array.isArray(data)) {
			...
			if (data15 && typeof data15 == "object" && !Array.isArray(data15)) {
				if (data15.payments === undefined) {
					const err35 = {
						...
						keyword: "required",
						params: { missingProperty: "payments" },
						message: "must have required property '" + "payments" + "'",
				...
				if (data15.payments !== undefined) {
					...
					if (Array.isArray(data16)) {
						if (data16.length < 2) {
							const err36 = {
								instancePath: instancePath + "/asset/payments",
								schemaPath: "#/properties/asset/properties/payments/minItems",
								keyword: "minItems",
								params: { limit: 2 },
								message: "must NOT have fewer than 2 items",
								schema: 2,
								parentSchema: schema60.properties.asset.properties.payments,
								data: data16,
							};
							if (vErrors === null) {
								vErrors = [err36];
						...
						for (let i2 = 0; i2 < len1; i2++) {
							...
							if (data17 && typeof data17 == "object" && !Array.isArray(data17)) {
								if (data17.amount === undefined) {
									const err37 = {
										instancePath: instancePath + "/asset/payments/" + i2,
										schemaPath: "#/properties/asset/properties/payments/items/required",
										keyword: "required",
										params: { missingProperty: "amount" },
										message: "must have required property '" + "amount" + "'",
										schema: schema60.properties.asset.properties.payments.items.required,
										parentSchema: schema60.properties.asset.properties.payments.items,
										data: data17,
									};
									if (vErrors === null) {
										vErrors = [err37];
								...
								if (data17.recipientId === undefined) {
									const err38 = {
										...
										schemaPath: "#/properties/asset/properties/payments/items/required",
										keyword: "required",
										params: { missingProperty: "recipientId" },
										message: "must have required property '" + "recipientId" + "'",
										schema: schema60.properties.asset.properties.payments.items.required,
										parentSchema: schema60.properties.asset.properties.payments.items,
										data: data17,
									};
								...
								if (data17.recipientId !== undefined) {
									if (
										!validate37(data17.recipientId, {
											instancePath: instancePath + "/asset/payments/" + i2 + "/recipientId",
											parentData: data17,
											parentDataProperty: "recipientId",
											rootData,
										})
									) {
										vErrors =
								...
								const err39 = {
									instancePath: instancePath + "/asset/payments/" + i2,
									schemaPath: "#/properties/asset/properties/payments/items/type",
									keyword: "type",
									params: { type: "object" },
									message: "must be object",
									schema: schema60.properties.asset.properties.payments.items.type,
									parentSchema: schema60.properties.asset.properties.payments.items,
									data: data17,
								};
								if (vErrors === null) {
						...
						const err40 = {
							instancePath: instancePath + "/asset/payments",
							schemaPath: "#/properties/asset/properties/payments/type",
							keyword: "type",
							params: { type: "array" },
							message: "must be array",
							schema: schema60.properties.asset.properties.payments.type,
							parentSchema: schema60.properties.asset.properties.payments,
							data: data16,
						};
						if (vErrors === null) {
		...
		if (data.vendorField !== undefined) {
			...
			if (data21 !== null) {
				const err42 = {
					instancePath: instancePath + "/vendorField",
					schemaPath: "#/properties/vendorField/anyOf/0/type",
					keyword: "type",
					params: { type: "null" },
					message: "must be null",
					schema: schema60.properties.vendorField.anyOf[0].type,
					parentSchema: schema60.properties.vendorField.anyOf[0],
					data: data21,
				};
				if (vErrors === null) {
					vErrors = [err42];
			...
			if (!valid18) {
				...
				if (typeof data21 !== "string") {
					const err43 = {
						...
						params: { type: "string" },
						message: "must be string",
						schema: schema60.properties.vendorField.anyOf[1].type,
						parentSchema: schema60.properties.vendorField.anyOf[1],
						data: data21,
					};
					if (vErrors === null) {
						vErrors = [err43];
			...
			if (!valid18) {
				const err44 = {
					...
					params: {},
					message: "must match a schema in anyOf",
					schema: schema60.properties.vendorField.anyOf,
					parentSchema: schema60.properties.vendorField,
					data: data21,
				};
				if (vErrors === null) {
					vErrors = [err44];
...
export const multiPaymentStrict = validate47;
const schema66 = {
	$id: "multiPaymentStrict",
	else: { required: ["type", "senderPublicKey", "fee", "amount", "nonce"] },
	if: { properties: { version: { anyOf: [{ type: "null" }, { const: 1 }] } } },
	properties: {
		amount: { bignumber: { minimum: 0, maximum: 0 } },
...
function validate47(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
	/*# sourceURL="multiPaymentStrict" */ let vErrors = null;
	let errors = 0;
	const _errs1 = errors;
	let valid0 = false;
	const _errs2 = errors;
					...
					if (typeof data12 === "string") {
						if (func2(data12) > 130) {
							const err34 = {
								...
								message: "must NOT have more than 130 characters",
								schema: 130,
								parentSchema: schema66.properties.signatures.items.allOf[0],
								data: data12,
							};
							if (vErrors === null) {
								vErrors = [err34];
					...
					if (Array.isArray(data16)) {
						if (data16.length < 2) {
							const err45 = {
								...
								message: "must NOT have fewer than 2 items",
								schema: 2,
								parentSchema: schema66.properties.asset.properties.payments,
								data: data16,
							};
							if (vErrors === null) {
								vErrors = [err45];
							...
							if (data17 && typeof data17 == "object" && !Array.isArray(data17)) {
								if (data17.amount === undefined) {
									const err46 = {
										...
										params: { missingProperty: "amount" },
										message: "must have required property '" + "amount" + "'",
										schema: schema66.properties.asset.properties.payments.items.required,
										parentSchema: schema66.properties.asset.properties.payments.items,
										data: data17,
									};
									if (vErrors === null) {
										vErrors = [err46];
								...
								const err48 = {
									...
									params: { type: "object" },
									message: "must be object",
									schema: schema66.properties.asset.properties.payments.items.type,
									parentSchema: schema66.properties.asset.properties.payments.items,
									data: data17,
								};
								if (vErrors === null) {
						...
						const err49 = {
							...
							params: { type: "array" },
							message: "must be array",
							schema: schema66.properties.asset.properties.payments.type,
							parentSchema: schema66.properties.asset.properties.payments,
							data: data16,
						};
						if (vErrors === null) {
		...
		if (data.vendorField !== undefined) {
			...
			if (data21 !== null) {
				const err51 = {
					...
					params: { type: "null" },
					message: "must be null",
					schema: schema66.properties.vendorField.anyOf[0].type,
					parentSchema: schema66.properties.vendorField.anyOf[0],
					data: data21,
				};
				if (vErrors === null) {
					vErrors = [err51];
			...
			if (!valid19) {
				...
				if (typeof data21 !== "string") {
					const err52 = {
						...
						params: { type: "string" },
						message: "must be string",
						schema: schema66.properties.vendorField.anyOf[1].type,
						parentSchema: schema66.properties.vendorField.anyOf[1],
						data: data21,
					};
					if (vErrors === null) {
						vErrors = [err52];
			...
			if (!valid19) {
				const err53 = {
					...
					params: {},
					message: "must match a schema in anyOf",
					schema: schema66.properties.vendorField.anyOf,
					parentSchema: schema66.properties.vendorField,
					data: data21,
				};
				if (vErrors === null) {
					vErrors = [err53];
...
export const multiPaymentSigned = validate51;
const schema72 = {
	$id: "multiPaymentSigned",
	else: { required: ["type", "senderPublicKey", "fee", "amount", "nonce"] },
	if: { properties: { version: { anyOf: [{ type: "null" }, { const: 1 }] } } },
	properties: {
		amount: { bignumber: { minimum: 0, maximum: 0 } },
...
function validate51(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
	/*# sourceURL="multiPaymentSigned" */ let vErrors = null;
	let errors = 0;
	const _errs1 = errors;
	let valid0 = false;
	const _errs2 = errors;
					...
					if (typeof data12 === "string") {
						if (func2(data12) > 130) {
							const err33 = {
								...
								message: "must NOT have more than 130 characters",
								schema: 130,
								parentSchema: schema72.properties.signatures.items.allOf[0],
								data: data12,
							};
							if (vErrors === null) {
								vErrors = [err33];
					...
					if (Array.isArray(data16)) {
						if (data16.length < 2) {
							const err44 = {
								...
								message: "must NOT have fewer than 2 items",
								schema: 2,
								parentSchema: schema72.properties.asset.properties.payments,
								data: data16,
							};
							if (vErrors === null) {
								vErrors = [err44];
							...
							if (data17 && typeof data17 == "object" && !Array.isArray(data17)) {
								if (data17.amount === undefined) {
									const err45 = {
										...
										params: { missingProperty: "amount" },
										message: "must have required property '" + "amount" + "'",
										schema: schema72.properties.asset.properties.payments.items.required,
										parentSchema: schema72.properties.asset.properties.payments.items,
										data: data17,
									};
									if (vErrors === null) {
										vErrors = [err45];
								...
								const err47 = {
									...
									params: { type: "object" },
									message: "must be object",
									schema: schema72.properties.asset.properties.payments.items.type,
									parentSchema: schema72.properties.asset.properties.payments.items,
									data: data17,
								};
								if (vErrors === null) {
						...
						const err48 = {
							...
							params: { type: "array" },
							message: "must be array",
							schema: schema72.properties.asset.properties.payments.type,
							parentSchema: schema72.properties.asset.properties.payments,
							data: data16,
						};
						if (vErrors === null) {
		...
		if (data.vendorField !== undefined) {
			...
			if (data21 !== null) {
				const err50 = {
					...
					params: { type: "null" },
					message: "must be null",
					schema: schema72.properties.vendorField.anyOf[0].type,
					parentSchema: schema72.properties.vendorField.anyOf[0],
					data: data21,
				};
				if (vErrors === null) {
					vErrors = [err50];
			...
			if (!valid19) {
				...
				if (typeof data21 !== "string") {
					const err51 = {
						...
						params: { type: "string" },
						message: "must be string",
						schema: schema72.properties.vendorField.anyOf[1].type,
						parentSchema: schema72.properties.vendorField.anyOf[1],
						data: data21,
					};
					if (vErrors === null) {
						vErrors = [err51];
			...
			if (!valid19) {
				const err52 = {
					...
					params: {},
					message: "must match a schema in anyOf",
					schema: schema72.properties.vendorField.anyOf,
					parentSchema: schema72.properties.vendorField,
					data: data21,
				};
				if (vErrors === null) {
					vErrors = [err52];
