...
var validate = (function() {
  ...
  refVal[4] = refVal4;
  return function validate(data, dataPath, parentData, parentDataProperty, rootData) {
    'use strict'; /*# sourceURL=multiSignature */
    var vErrors = null;
    var errors = 0;
    if (rootData === undefined) rootData = data;
    if ((data && typeof data === "object" && !Array.isArray(data))) {
      ...
      if (data1 === undefined) {
        ...
        var err = {
          ...
          message: 'should have required property \'signatures\''
        };
        if (vErrors === null) vErrors = [err];
        else vErrors.push(err);
        errors++;
        ...
        if (Array.isArray(data1)) {
          var schema1 = data && data.asset && data.asset.multiSignature && data.asset.multiSignature.publicKeys && data.asset.multiSignature.publicKeys.length;
          if ((schema1 !== undefined && typeof schema1 != 'number') || data1.length > schema1) {
            var err = {
              keyword: 'maxItems',
              ...
              message: 'should NOT have more than ' + schema1 + ' items'
            };
            if (vErrors === null) vErrors = [err];
            else vErrors.push(err);
            errors++;
          }
          var schema1 = data && data.asset && data.asset.multiSignature && data.asset.multiSignature.min;
          if ((schema1 !== undefined && typeof schema1 != 'number') || data1.length < schema1) {
            var err = {
              keyword: 'minItems',
              dataPath: (dataPath || '') + '.signatures',
              ...
              message: 'should NOT have fewer than ' + schema1 + ' items'
            };
            if (vErrors === null) vErrors = [err];
            else vErrors.push(err);
            errors++;
      ...
      if (data1 === undefined) {
        ...
        if ((data1 && typeof data1 === "object" && !Array.isArray(data1))) {
          var errs__1 = errors;
          var valid2 = true;
          var data2 = data1.multiSignature;
          if (data2 === undefined) {
            valid2 = false;
            var err = {
              keyword: 'required',
              ...
              params: {
                missingProperty: 'multiSignature'
              },
              message: 'should have required property \'multiSignature\''
            };
            if (vErrors === null) vErrors = [err];
            else vErrors.push(err);
            errors++;
            ...
            if ((data2 && typeof data2 === "object" && !Array.isArray(data2))) {
              ...
              if (data3 === undefined) {
                ...
                var err = {
                  keyword: 'required',
                  dataPath: (dataPath || '') + '.asset.multiSignature',
                ...
                if ((typeof data3 !== "number" || (data3 % 1) || data3 !== data3)) {
                  var err = {
                    keyword: 'type',
                    dataPath: (dataPath || '') + '.asset.multiSignature.min',
                ...
                if ((typeof data3 === "number")) {
                  var schema3 = data2 && data2.publicKeys && data2.publicKeys.length;
                  if ((schema3 !== undefined && typeof schema3 != 'number') || data3 > schema3 || data3 !== data3) {
                    var err = {
                      keyword: 'maximum',
                      dataPath: (dataPath || '') + '.asset.multiSignature.min',
                      schemaPath: '#/properties/asset/properties/multiSignature/properties/min/maximum',
                      params: {
                        comparison: '<=',
                        limit: schema3,
                        exclusive: false
                  ...
                  if (data3 < 1 || data3 !== data3) {
                    var err = {
                      keyword: 'minimum',
                      dataPath: (dataPath || '') + '.asset.multiSignature.min',
                      schemaPath: '#/properties/asset/properties/multiSignature/properties/min/minimum',
                      params: {
                        comparison: '>=',
                        limit: 1,
                        exclusive: false
              ...
              if (data3 === undefined) {
                ...
                var err = {
                  ...
                  schemaPath: '#/properties/asset/properties/multiSignature/required',
                  params: {
                    missingProperty: 'publicKeys'
                  },
                  message: 'should have required property \'publicKeys\''
                };
                if (vErrors === null) vErrors = [err];
                else vErrors.push(err);
                errors++;
                ...
                if (Array.isArray(data3)) {
                  if (data3.length > 16) {
                    var err = {
                      keyword: 'maxItems',
                      dataPath: (dataPath || '') + '.asset.multiSignature.publicKeys',
                      schemaPath: '#/properties/asset/properties/multiSignature/properties/publicKeys/maxItems',
                      params: {
                        limit: 16
                      },
                  ...
                  if (data3.length < 1) {
                    var err = {
                      keyword: 'minItems',
                      dataPath: (dataPath || '') + '.asset.multiSignature.publicKeys',
                      schemaPath: '#/properties/asset/properties/multiSignature/properties/publicKeys/minItems',
                      params: {
                        limit: 1
                      },
                  ...
                  for (var i3 = 0; i3 < data3.length; i3++) {
                    var errs_4 = errors;
                    if (!refVal[4](data3[i3], (dataPath || '') + '.asset.multiSignature.publicKeys[' + i3 + ']', data3, i3, rootData)) {
                  ...
                  if (!valid3) {
                    var err = {
                      keyword: 'uniqueItems',
                      dataPath: (dataPath || '') + '.asset.multiSignature.publicKeys',
                      schemaPath: '#/properties/asset/properties/multiSignature/properties/publicKeys/uniqueItems',
                      params: {
                        i: i,
                        j: j
                      },
                  ...
                  var err = {
                    keyword: 'type',
                    dataPath: (dataPath || '') + '.asset.multiSignature.publicKeys',
                    schemaPath: '#/properties/asset/properties/multiSignature/properties/publicKeys/type',
                    params: {
                      type: 'array'
                    },
                    message: 'should be array'
