...
const schema47 = { "$id": "vote", "else": { "required": ["type", "senderPublicKey", "fee", "amount", "nonce"] }, "if": { "properties": { "version": { "anyOf": [{ "type": "null" }, { "const": 1 }] } } }, "properties": { "amount": { "bignumber": { "minimum": 0, "maximum": 0 } }, "fee": { "bignumber": { "minimum": 1 } }, "id": { "type": "string" }, "network": { "$ref": "networkByte" }, "nonce": { "bignumber": { "minimum": 0 } }, "secondSignature": { "type": "string" }, "senderPublicKey": { "type": "string" }, "signSignature": { "type": "string" }, "signature": { "type": "string" }, "version": { "enum": [1, 2] }, "signatures": { "items": { "type": "string" }, "maxItems": 16, "minItems": 1, "type": "array" }, "timestamp": { "type": "integer", "minimum": 0 }, "typeGroup": { "minimum": 0, "type": "integer" }, "asset": { "properties": { "votes": { "minItems": 1, "maxItems": 2, "type": "array" } }, "required": ["votes"], "type": "object" }, "recipientId": { "type": "string" }, "type": { "transactionType": 3 } }, "then": { "required": ["type", "senderPublicKey", "fee", "amount", "timestamp"] }, "type": "object", "required": ["asset"] };
function validate33(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { /*# sourceURL="vote" */ ; let vErrors = null; let errors = 0; const _errs1 = errors; let valid0 = true; const _errs2 = errors; if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.asset !== undefined) {
        ...
        if (data15 && typeof data15 == "object" && !Array.isArray(data15)) {
            if (data15.votes === undefined) {
                const err29 = { instancePath: instancePath + "/asset", schemaPath: "#/properties/asset/required", keyword: "required", params: { missingProperty: "votes" }, message: "must have required property '" + "votes" + "'", schema: schema47.properties.asset.required, parentSchema: schema47.properties.asset, data: data15 };
                if (vErrors === null) {
                    vErrors = [err29];
                }
                else {
            ...
            if (data15.votes !== undefined) {
                ...
                if (Array.isArray(data16)) {
                    if (data16.length > 2) {
                        const err30 = { instancePath: instancePath + "/asset/votes", schemaPath: "#/properties/asset/properties/votes/maxItems", keyword: "maxItems", params: { limit: 2 }, message: "must NOT have more than 2 items", schema: 2, parentSchema: schema47.properties.asset.properties.votes, data: data16 };
                        if (vErrors === null) {
                            vErrors = [err30];
                        }
                        else {
                    ...
                    if (data16.length < 1) {
                        const err31 = { instancePath: instancePath + "/asset/votes", schemaPath: "#/properties/asset/properties/votes/minItems", keyword: "minItems", params: { limit: 1 }, message: "must NOT have fewer than 1 items", schema: 1, parentSchema: schema47.properties.asset.properties.votes, data: data16 };
                        if (vErrors === null) {
                            vErrors = [err31];
                        }
                        else {
                    ...
                    const err32 = { instancePath: instancePath + "/asset/votes", schemaPath: "#/properties/asset/properties/votes/type", keyword: "type", params: { type: "array" }, message: "must be array", schema: schema47.properties.asset.properties.votes.type, parentSchema: schema47.properties.asset.properties.votes, data: data16 };
                    if (vErrors === null) {
                        vErrors = [err32];
                    }
                    else {
    ...
    if (data.recipientId !== undefined) {
        let data17 = data.recipientId;
        if (typeof data17 !== "string") {
            const err34 = { instancePath: instancePath + "/recipientId", schemaPath: "#/properties/recipientId/type", keyword: "type", params: { type: "string" }, message: "must be string", schema: schema47.properties.recipientId.type, parentSchema: schema47.properties.recipientId, data: data17 };
            if (vErrors === null) {
                vErrors = [err34];
            }
            else {
...
const schema49 = { "$id": "voteStrict", "else": { "required": ["type", "senderPublicKey", "fee", "amount", "nonce"] }, "if": { "properties": { "version": { "anyOf": [{ "type": "null" }, { "const": 1 }] } } }, "properties": { "amount": { "bignumber": { "minimum": 0, "maximum": 0 } }, "fee": { "bignumber": { "minimum": 1 } }, "id": { "type": "string" }, "network": { "$ref": "networkByte" }, "nonce": { "bignumber": { "minimum": 0 } }, "secondSignature": { "type": "string" }, "senderPublicKey": { "type": "string" }, "signSignature": { "type": "string" }, "signature": { "type": "string" }, "version": { "enum": [1, 2] }, "signatures": { "items": { "type": "string" }, "maxItems": 16, "minItems": 1, "type": "array" }, "timestamp": { "type": "integer", "minimum": 0 }, "typeGroup": { "minimum": 0, "type": "integer" }, "asset": { "properties": { "votes": { "minItems": 1, "maxItems": 2, "type": "array" } }, "required": ["votes"], "type": "object" }, "recipientId": { "type": "string" }, "type": { "transactionType": 3 } }, "then": { "required": ["type", "senderPublicKey", "fee", "amount", "timestamp"] }, "type": "object", "required": ["asset"], "anyOf": [{ "required": ["id", "signature"] }, { "required": ["id", "signature", "signatures"] }, { "required": ["id", "signatures"] }], "additionalProperties": false };
const func2 = Object.prototype.hasOwnProperty;
function validate34(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { /*# sourceURL="voteStrict" */ ; let vErrors = null; let errors = 0; const _errs1 = errors; let valid0 = false; const _errs2 = errors; if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.id === undefined) {
    ...
    if (data.asset !== undefined) {
        ...
        if (data15 && typeof data15 == "object" && !Array.isArray(data15)) {
            if (data15.votes === undefined) {
                const err38 = { instancePath: instancePath + "/asset", schemaPath: "#/properties/asset/required", keyword: "required", params: { missingProperty: "votes" }, message: "must have required property '" + "votes" + "'", schema: schema49.properties.asset.required, parentSchema: schema49.properties.asset, data: data15 };
                if (vErrors === null) {
                    vErrors = [err38];
                }
                else {
            ...
            if (data15.votes !== undefined) {
                ...
                if (Array.isArray(data16)) {
                    if (data16.length > 2) {
                        const err39 = { instancePath: instancePath + "/asset/votes", schemaPath: "#/properties/asset/properties/votes/maxItems", keyword: "maxItems", params: { limit: 2 }, message: "must NOT have more than 2 items", schema: 2, parentSchema: schema49.properties.asset.properties.votes, data: data16 };
                        if (vErrors === null) {
                            vErrors = [err39];
                        }
                        else {
                    ...
                    if (data16.length < 1) {
                        const err40 = { instancePath: instancePath + "/asset/votes", schemaPath: "#/properties/asset/properties/votes/minItems", keyword: "minItems", params: { limit: 1 }, message: "must NOT have fewer than 1 items", schema: 1, parentSchema: schema49.properties.asset.properties.votes, data: data16 };
                        if (vErrors === null) {
                            vErrors = [err40];
                        }
                        else {
                    ...
                    const err41 = { instancePath: instancePath + "/asset/votes", schemaPath: "#/properties/asset/properties/votes/type", keyword: "type", params: { type: "array" }, message: "must be array", schema: schema49.properties.asset.properties.votes.type, parentSchema: schema49.properties.asset.properties.votes, data: data16 };
                    if (vErrors === null) {
                        vErrors = [err41];
                    }
                    else {
    ...
    if (data.recipientId !== undefined) {
        let data17 = data.recipientId;
        if (typeof data17 !== "string") {
            const err43 = { instancePath: instancePath + "/recipientId", schemaPath: "#/properties/recipientId/type", keyword: "type", params: { type: "string" }, message: "must be string", schema: schema49.properties.recipientId.type, parentSchema: schema49.properties.recipientId, data: data17 };
            if (vErrors === null) {
                vErrors = [err43];
            }
            else {
...
const schema51 = { "$id": "voteSigned", "else": { "required": ["type", "senderPublicKey", "fee", "amount", "nonce"] }, "if": { "properties": { "version": { "anyOf": [{ "type": "null" }, { "const": 1 }] } } }, "properties": { "amount": { "bignumber": { "minimum": 0, "maximum": 0 } }, "fee": { "bignumber": { "minimum": 1 } }, "id": { "type": "string" }, "network": { "$ref": "networkByte" }, "nonce": { "bignumber": { "minimum": 0 } }, "secondSignature": { "type": "string" }, "senderPublicKey": { "type": "string" }, "signSignature": { "type": "string" }, "signature": { "type": "string" }, "version": { "enum": [1, 2] }, "signatures": { "items": { "type": "string" }, "maxItems": 16, "minItems": 1, "type": "array" }, "timestamp": { "type": "integer", "minimum": 0 }, "typeGroup": { "minimum": 0, "type": "integer" }, "asset": { "properties": { "votes": { "minItems": 1, "maxItems": 2, "type": "array" } }, "required": ["votes"], "type": "object" }, "recipientId": { "type": "string" }, "type": { "transactionType": 3 } }, "then": { "required": ["type", "senderPublicKey", "fee", "amount", "timestamp"] }, "type": "object", "required": ["asset"], "anyOf": [{ "required": ["id", "signature"] }, { "required": ["id", "signature", "signatures"] }, { "required": ["id", "signatures"] }] };
function validate35(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { /*# sourceURL="voteSigned" */ ; let vErrors = null; let errors = 0; const _errs1 = errors; let valid0 = false; const _errs2 = errors; if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.id === undefined) {
    ...
    if (data.asset !== undefined) {
        ...
        if (data15 && typeof data15 == "object" && !Array.isArray(data15)) {
            if (data15.votes === undefined) {
                const err37 = { instancePath: instancePath + "/asset", schemaPath: "#/properties/asset/required", keyword: "required", params: { missingProperty: "votes" }, message: "must have required property '" + "votes" + "'", schema: schema51.properties.asset.required, parentSchema: schema51.properties.asset, data: data15 };
                if (vErrors === null) {
                    vErrors = [err37];
                }
                else {
            ...
            if (data15.votes !== undefined) {
                ...
                if (Array.isArray(data16)) {
                    if (data16.length > 2) {
                        const err38 = { instancePath: instancePath + "/asset/votes", schemaPath: "#/properties/asset/properties/votes/maxItems", keyword: "maxItems", params: { limit: 2 }, message: "must NOT have more than 2 items", schema: 2, parentSchema: schema51.properties.asset.properties.votes, data: data16 };
                        if (vErrors === null) {
                            vErrors = [err38];
                        }
                        else {
                    ...
                    if (data16.length < 1) {
                        const err39 = { instancePath: instancePath + "/asset/votes", schemaPath: "#/properties/asset/properties/votes/minItems", keyword: "minItems", params: { limit: 1 }, message: "must NOT have fewer than 1 items", schema: 1, parentSchema: schema51.properties.asset.properties.votes, data: data16 };
                        if (vErrors === null) {
                            vErrors = [err39];
                        }
                        else {
                    ...
                    const err40 = { instancePath: instancePath + "/asset/votes", schemaPath: "#/properties/asset/properties/votes/type", keyword: "type", params: { type: "array" }, message: "must be array", schema: schema51.properties.asset.properties.votes.type, parentSchema: schema51.properties.asset.properties.votes, data: data16 };
                    if (vErrors === null) {
                        vErrors = [err40];
                    }
                    else {
    ...
    if (data.recipientId !== undefined) {
        let data17 = data.recipientId;
        if (typeof data17 !== "string") {
            const err42 = { instancePath: instancePath + "/recipientId", schemaPath: "#/properties/recipientId/type", keyword: "type", params: { type: "string" }, message: "must be string", schema: schema51.properties.recipientId.type, parentSchema: schema51.properties.recipientId, data: data17 };
            if (vErrors === null) {
                vErrors = [err42];
            }
            else {
...
export { validate33 as vote };
export { validate34 as voteStrict };
export { validate35 as voteSigned };
